...
(§14 is ~10k), and most of the 89 rows below are under 2k. Ranges shift
...
```text
§0          137-156  Objective
§1          158-187  Inputs and parameter mappings (unchanged from the articl…
§2          189-306  Productivity curve — v2 change
§3          308-434  Optimal stopping — v2 change: per-task, no longer a univ…
§4          436-537  Allocation — v2 change: discrete blocks, exact greedy, e…
§5          539-872  Personalization — v2 change: full Bayesian posterior
  §5.2      589-675  Recency weighting of the ϕ fit (added 2026-08-04)
  §5.1      677-872  Posterior-aware allocation (added 2026-07-18)
§6          874-886  Summary of v1 → v2 changes
§7          888-939  Known approximations and deliberate non-changes
§8         941-2974  Energy model (zenith-energy.ts) — fatigue-recovery exten…
  §8.1      959-984  Intermittent-rest recovery correction
  §8.2     986-1008  Warm-up carryover instead of binary reset
  §8.3    1010-1093  Verified consequences and a calibration question, closed
  §8.4    1095-1206  Per-task satiety — concave daily value (added 2026-07-14)
  §8.5    1208-1275  Micro-recovery gate — a positive floor for full-demand t…
  §8.6    1277-1465  Optimizer reliability — compound moves and drop-one seed…
  §8.7    1467-1599  Drain-rate calibration from end-of-session ratings (adde…
  §8.8    1601-1678  45-minute plan granularity (added 2026-07-18)
  §8.9    1680-1754  Recovery-rate calibration from pre/post-rest pairs (adde…
  §8.10   1756-2492  Stopping-value calibration from observed stop times (add…
  §8.11   2494-2765  Live stop advisor — §8.10 run forward mid-day (added 202…
  §8.12   2767-2974  The budget curve — what the day's LENGTH is worth (added…
§9        2976-3023  References
§10       3025-4067  Revision log (doc-only corrections)
§11       4069-4704  Metric-layer corrections (2026-07-18)
  §11.1   4071-4085  Scope and principle
  §11.2   4087-4111  Zenith Gain: cap instead of a silent 0% when the naive p…
  §11.3   4113-4140  Burnout Risk: overhang counts funded tasks' T* only (for…
  §11.4   4142-4212  Friction Index: raw scales instead of the asymmetric map…
  §11.5   4214-4232  Schedule Integrity: overhead share instead of the small-…
  §11.6   4234-4358  Burnout Risk v2: re-derived from the energy model (2026-…
  §11.7   4360-4384  Momentum: burnout claim removed, fed active tasks (2026-…
  §11.8   4386-4452  Metric scope families: plan / progress / next-up (2026-0…
  §11.9   4454-4563  Overnight reservoir carry-over (2026-07-28)
  §11.10  4565-4635  Grind Density: the share of the work the day actually fu…
  §11.11  4637-4704  Grind Density is a row, not an objective (2026-08-08)
§12       4706-4843  Plan-adherence audit (2026-07-23)
  §12.1   4747-4843  Per-day fit snapshots (2026-08-03)
§13       4845-5307  Math review, 2026-07-26
  §13.1   4862-4900  Zero ⚡ logs was treated as perfect certainty (§5, §5.1)
  §13.2   4902-4974  Zenith Gain measured the block lattice, not allocation q…
  §13.3   4976-5041  The pooled allocator's "within 1–2%" was a curated-scena…
  §13.4   5043-5096  The stopping fit probed unlogged tasks at an arbitrary p…
  §13.5   5098-5135  Also in this change
  §13.6   5137-5307  The two end-of-day energy readings: a timing difference,…
§14       5309-6232  Plan advice — priced counterfactuals over the day's leve…
  §14.1   5563-5709  Five corrections to the first cut (2026-07-28)
  §14.2   5711-5860  The marginal of the budget (added 2026-08-03)
  §14.3   5862-6068  The price of the switch cost (added 2026-08-04)
  §14.4   6070-6131  An empty frontier is a reading (2026-08-08)
  §14.5   6133-6232  Flow Coverage becomes the ninth axis (2026-08-24)
§15       6234-6392  Two objectives, two modes (2026-07-29)
  §15.1   6320-6392  The copy named the wrong objective for both modes (2026-…
§16       6394-6482  Run order stays a heuristic (2026-07-29)
§17       6484-6642  Per-task ϕ offsets stay unbuilt (2026-08-04)
§18       6644-6749  Drain logs are one row per SESSION, not per task-day (20…
§19       6751-7022  The gain's naive baseline paid for switches it never mad…
  §19.1   6769-6828  Defect 1 — billed (n−1) switches, seated fewer than n ta…
  §19.2   6830-6858  Defect 2 — the displayed number moved with the order of …
  §19.3   6860-6949  What this costs, and the one guarantee that weakened
  §19.4   6951-7022  GAIN_PERCENT_CAP is not dead, but its documented trigger…
§20       7024-7086  Human Capacity: the reading is the constraint, but it na…
  §20.1   7065-7086  The tie went to cognitive, so the row blamed the wrong p…
§21       7088-7256  What the gain has room to report (2026-08-07)
  §21.1   7110-7130  The edge is SELECTION at tight budgets and SHAPE at loos…
  §21.2   7132-7155  Why shape has a low ceiling: the activation bonus
  §21.3   7157-7177  Population distribution
  §21.4   7179-7210  The number is a property of the comparison, not of the o…
  §21.5   7212-7227  Under the total-output objective the ranking inverts
  §21.6   7229-7256  Correction: on an ordinary day it is FLOW that binds, no…
§22       7258-7331  Task nature: an absolute gap could not carry a range tha…
§23       7333-7475  Primary Bottleneck named the model's best task (2026-08-…
  §23.1   7374-7441  Primary Bottleneck: the largest draw on the binding pool
  §23.2   7443-7475  Longest Warm-Up: what E/β was actually tracking
§24       7477-7540  Task Variety counted labels, and its repair was Energy B…
§25       7542-7691  Cognitive and Physical Load: the definition, and what ro…
§26       7693-7799  Deep Work: a step that swung whole blocks, under a band …
§27       7801-7918  Sustainable Work billed unbooked time as grind (2026-08-…
§28       7920-7972  Which four readings are headlines (2026-08-07)
§29       7974-8147  Day Profile: one cut for two different scales, on a day …
§30       8149-8241  The Lab's comparison tile scored the plan on the one thi…
§31       8243-8424  What history can plot, and what it cannot (2026-08-07)
§32       8426-8492  Two gates that read a sentinel as a verdict (2026-08-08)
§33       8494-8619  A plan reads only the logs that precede it (2026-08-08)
§34       8621-8857  The subset search gave up one task too early (2026-08-08)
§35       8859-9213  The plan cannot see the hours you already spent (2026-08…
§36       9215-9286  What a correction may touch (2026-08-10)
§37       9288-9431  Time Scarcity billed switches for tasks the plan never s…
```
...
and a stable sort then settles the tie by the order they arrived in. Measured, the
print's own contribution is **small**: of 990 adjacent-mental-difficulty pairs
(physical 0–10 × enjoyment 1–10) 232 print the same score, but only 760 of them
differ in effective difficulty at all — `getEffectiveDifficulty` clamps at 10,
so 230 of the ties are tied before the print ever sees them. That leaves **2 of
760 (0.26%)**: `m/p/e 1/2/1` and `2/2/1` (effective difficulty 2.3 against 2.6)
both print 8.2, and `1/2/2` and `2/2/2` both print 9.1. The tie reaches the
printed order — the same two tasks plan as `[m1p2e1, m2p2e1]` listed one way and
`[m2p2e1, m1p2e1]` the other — and `calculateInterleavedOrder`'s seed sort with
it. It does **not** reach the Yield Index, which sums the same rounded key it
sorts by, so a swap cannot move its top-N sum (100 forward, 100 reversed). The
day's list is not this array either: its funded group is re-sorted by `#N` (§16).
`scripts/mtr-priority-monotonicity.probe.ts`, 2026-08-25.
...
disagree on a tie, bounded by the 2 pairs above. Neither site moves: the raw key
is strictly finer, and the plan path must print the rounded one.

**P̄(T\*) is not monotone in difficulty, and the cap is not why**
(`scripts/mtr-priority-monotonicity.probe.ts`, 2026-08-25). Write the closed form
as `P̄(T*)/β = E·h(r(E))` with `r = 1/E²` (§1). Swept over effective difficulty
1 → 10 in steps of 0.01 at enjoyment 5, `P̄(T*)` reads **1.3053** at difficulty
1, rises to an interior local max of **1.3749** at difficulty 1.12, falls to a
trough of **1.1809** at difficulty 2.27 — **9.53% below the difficulty-1 value**
— and first regains it at difficulty **3.92** (1.3060). The depth is β-free: the
same sweep drops 9.53% at enjoyment 1 and 9.53% at enjoyment 10.

**The cap is not the cause, on two readings.** `r` sits flat at its maximum
0.9000 for every effective difficulty up to **1.1217** (§1's sliver, read off
this run as true effort E = 1.0541) and strictly below it above — 0.8937 at
difficulty 1.13, 0.0400 at difficulty 10 — so the trough at 2.27 sits **1.15 of
difficulty outside the capped band**, which the sweep has already left by 1.13.
And `h` is constant on the 13 capped sweep points (h = 0.903658, spread
1.44e-15) while `a = Eβ` keeps growing, which is the whole of the rise into the
local max; above the cap `h` falls with difficulty on **887 of 887 steps, 0
exceptions** (0.897864 at difficulty 1.13 down to 0.317322 at difficulty 10).
The two sides of `P̄/β = E·h(r)` agree to 2.22e-16 over all 901 points and `h`
is a function of `r` alone. The dip is the closed form's.

**Lowering or removing the cap DEEPENS it.** Shipped and capped, difficulty 1
has `r` pinned at 0.9000 and h = 0.903658, so `P̄/β` reads 0.903658 against the
trough's 0.817547 — the 9.53% drop. Uncapped, difficulty 1 has r = 1 and h → 1
(this section's r → 1 asymptote — a limit, not a run figure, and the only figure
here that is not), so `P̄/β` would read 1.000000 and the same trough would be a
drop of **18.25%**. The cap **shrinks** the dip by 8.72 points.

**What the integer sliders reach is 1.7 points.** Over the 100 mental ×
enjoyment cells at physical 0, the worst a harder task falls below an easier one
on the printed score is 1.7: `m/p/e 1/0/10` (effective difficulty 1.0) prints
18.1 while the harder `2/0/10` (effective 2.0) prints 16.4. Over the whole 110
mental × physical grid × 10 enjoyments — every effective difficulty the sliders
can mix — the worst is the same 1.7: `1/0/10` at 18.1 against the harder
`1/2/10` (effective 2.3) at 16.4.
...
**Measured, and priced** (`scripts/satiety-gaming.probe.ts`, re-read 2026-08-25
on the app's constraint surface — the 2026-08-06 reading it replaces built tasks
with `difficulty = max(mental, physical)`, skipping the 0.3 spillover, so no day
it generated was one a user could have declared; ROADMAP M40). The rule holds
exactly: over 300 random schedules — 297 of which split a task across a gap —
`satiatedOutput` is reproduced to **1.07·10⁻¹⁴** by a replica that reads only the
per-task output TOTALS, so satiety demonstrably cannot see session count or gap
length. That is an identity rather than a fit, which is why it is the only figure
here the surface change barely moved: it read 8.9·10⁻¹⁵ on days the app cannot
produce and reads the same zero on days it can. What the rule BUYS had never been
measured, and it is not nothing. Enumerating every one of the 6561 lattice plans
on 24 days × 2 tasks and taking the argmax under three accumulators built from
the same per-block outputs:

| accumulator             | sessions/day | top task's share | worth under the satiety term Σ V(O) |
| ----------------------- | ------------ | ---------------- | ----------------------------------- |
| cumulative (shipped)    | 2.04         | 78.1%            | —                                   |
| session-keyed           | 2.42         | **96.4%**        | −1.710%                             |
| phase-decaying `e^−g/τ` | 2.38         | 94.0%            | −1.341%                             |

Both mutants fragment more AND concentrate harder — the session-keyed one puts
96.4% of worked hours on a single task against the shipped rule's 78.1%, which is
the re-run-the-winner corner §8.4 was written to close, reproduced on demand. That
last column is the satiety term alone, not the objective: scored against what
`optimizeSchedule` actually maximizes (Σ V(O) plus the leisure and terminal
terms) the mutants' plans lose **2.980%** (session-keyed) and **2.415%**
(phase-decaying) — the mutants work more hours for less value, so the leisure
term widens both gaps (both columns printed by
`scripts/satiety-gaming.probe.ts`, 2026-08-25). The two columns used to rank the
mutants in OPPOSITE orders and this section said so; on the app's own surface they
agree, both making the session-keyed rule the worse of the two, so the reversal
was a property of the unreachable population. The constraint is worth ~2–3% of the
objective, and ~1.3–1.7% of output value alone.
...
|replica fit − shipped fit| = 0 over 90 users × 12 days at q = 0.5. Both
populations below are ones the app can hold, each from the run that put it on the
surface: `stop-inversion-margin` on 2026-08-19 — of its **30381** logged rows
across the composition, optimizer and ±1-step days, **0** carry an hour count, a
window or a log moment the app could not produce (whole minutes in [1, 960], a
window in (0, 24]) — and `stop-margin-fit-error` only on **2026-08-25**, which is
why the second bullet's figures moved again and none of its earlier ones is
quotable (ROADMAP M40).
...
- **It does not measurably improve λ₀ recovery, and "biased λ₀ up" is a
  ...
  **+0.0285 λ₀** (30%-interrupted, q = 0.75, n = 12), then +0.0206 and +0.0202 —
  and **loses the other 9**, by up to 0.0560 at q = 0.75 — everything inside or near the 0.134
  half-width `stop-margin-fit-error` still prices against (re-read 2026-08-25 with
  every task drawn from integer sliders through `toEnergyTask`; the 2026-08-21
  reading gave best +0.0131, worst −0.0723, the 2026-08-19 one gains in 2, best
  +0.0084, worst −0.0796, and the break-free reading before that +0.0054 and
  −0.0859). What the slider-drawn population changed is not the verdict but where
  the gains sit: **all three are now the contaminated arm at n = 12**, at every
  completion rate, where before they were split across both mixes — the corrected
  scope helps where the population it reads is contaminated and n is large enough
  for the prior to let go, and nowhere else. The signed error does move in the
  asserted direction where the old scope is biased up (+0.0751 → +0.0337 at
  q = 0.25, n = 12) and then
  overshoots down (−0.0022 at q = 0.5, −0.0417 at q = 0.75). The used-day counts
  differ by construction, both ways: the corrected scope drops all-completed
  days and un-censors inverted ones (756 against 771 at q = 0.25, 678 against
  771 at q = 0.75).
...
- **λ₀ recovery RMSE, mixed cell:** 0.2654 → 0.2402 at n = 3 and
  0.2105 → 0.1701 at n = 12 — a gain of 0.0252 / **0.0403**, 22.9% / 36.7% of the
  gate. The censored fit does use far more of the calendar (55.2% → 81.5% of days,
  90.0% → 100% of users at n = 3), and it is still not worth the 0.110 the
  instrument already concedes. **Kill criterion fired.** (Re-read twice since,
  and the figures above are the third reading. 2026-08-25 put every task on the
  app's constraint surface — integer sliders through `toEnergyTask`, ROADMAP M40
  — which moved every number in this record; the off-surface reading of these
  cells was 0.2350 → 0.2055 and 0.1950 → 0.1458, gains 0.0295 / 0.0492.
  2026-08-21 added M42's clock censor, which took days out of both arms; before
  it the cells read 0.2299 → 0.2015 and 0.1713 → 0.1277, gains 0.0283 / 0.0437.
  The verdict is the same on all three, and the on-surface gain is the smallest
  of them.)
- **The fifth category ALONE makes the fit worse:** 0.1040 → 0.1302 RMSE at
  n = 12, bias −0.0135 → −0.1134. Its bound is almost never wrong — the truth
  breaks `λ₀ ≤ hi` on 0.3% of 900 all-completed days — but it is LOOSE, `hi`
...
- **A sub-step day's lower bound is wrong essentially always:** the truth breaks
  `λ₀ ≥ lo` on **100%** of 1080 sliver days. A day carrying less than one step on
  ...
  on 0.5% of 373 days — and that count is the third finding: generated honestly,
  by re-planning against a window one step shorter than λ₀ wanted, a
  worked-to-the-edge day is one-sided only 373 times in 1080, because the re-plan
  is still free to rest. The category is rarer than its name suggests.
- **No cell clears the gate, and two lose.** Re-read 2026-08-25, the gains are
  +0.0165 / **+0.0826** honest, +0.0252 / +0.0403 mixed, +0.0580 / **−0.0122**
  all-censored (n = 3 / n = 12), against −0.0050 / **−0.0262** on the
  all-completed-only cell. The largest anywhere is the honest n = 12 cell at
  +0.0826, still under the 0.110 gate — and it is not the cell the gate is set
  on, which is the mixed one at 36.7% of it. The all-censored cell is not a
  like-for-like contrast
  at all: there the shipped arm has no fit, returning the prior for every user,
  so it is scored against the prior's own error — and on days the app can hold it
  loses at n = 12 anyway, where off-surface it gained.
...
- **That posterior std is WITHIN-MODEL, and cannot see the conditioning it was
  read under** (measured 2026-08-24,
  `scripts/stp-stopping-identifiability.probe.ts`). It prices how the day points
  scatter around the fit — and every point was read under the same
  (α, r, ϕ-plane, V_T), so a mis-set slider is COMMON-MODE: it slides the whole
  history one way and the i.i.d.-days arithmetic never widens for it. Over 12
  seeded slider-reachable days per level, planned at the default V_T = 1.5 and
  re-read at the ends of V_T's own Energy Lab range [0, 5], λ̂₀ moves **0.211 /
  0.167 / 0.144 / 0.055** at true λ₀ 0.5 / 0.7 / 0.9 / 1.1 — **2.2× / 3.0× /
  3.3× / 1.0× the std printed beside it** — while `usedCount` is identical at
  every V_T and the std itself moves at most 0.010. So "λ̂₀ 0.88 ± 0.04" bounds
  the sampling error of the days read and says nothing about the slider they
  were read under, which is the shape the unfitted error source of feasibility 2
  takes at the estimator. The ± is not wrong; it is answering a narrower
  question than it looks like it is answering.
...
- **Re-derived 2026-08-13, and it is not derivable**
  ...
  constant): re-read 2026-08-25 with every task drawn from integer sliders through
  `toEnergyTask`, so every day in the sweep is one a user could have declared, at
  n = 12 days per user it
  moves 0.1441–0.1442 on honest days
  (spread 0.0001) and 0.2133–0.2205 on a 30%-interrupted mix (0.0072); at n = 3,
  where the prior gives ONE day half the fit and the constant has whatever
  leverage it has, 0.1701–0.1708 (0.0008) and 0.2138–0.2204 (0.0066). Every level
  is worse again than the off-surface 2026-08-21 reading (0.1200–0.1202,
  0.1581–0.1657, 0.1380–0.1383, 0.1748–0.1836), which was itself worse than the
  2026-08-19 one (0.0908–0.0910,
  ...
  0.1355–0.1401 and 0.1583–0.1632. **The level rose in all four arms, and the
  population is what moved.** A slider-drawn task carries
  `min(10, max(p, m) + 0.3·min(p, m))` and admits a 0 on one dimension; the
  hand-built one carried `max(p, m)` at a floor of 1 — so the spillover makes
  every two-dimensional task strictly harder and the surface reaches days the old
  draw could not. Which of the two moves the RMSE is not separated here and this
  sweep cannot separate it; what it establishes is that the level every figure in
  this section is read at belongs to the population the app can actually produce,
  and did not before. **Flat here is a claim about MAGNITUDE, in λ₀
  units, not about error bars overlapping**: the largest movement anywhere in the
  range is **0.0072**, which is 5.4% of the 0.134 bracket half-width that probe
  still prices against and 2.9% of σ₀ = 0.25 — an order of magnitude below the
  ...
  days, structurally censored ones included — moves 70.4% → 70.7% (honest, n = 3)
  and 74.5% → 78.0% (contaminated, n = 12) from m = 0.1 to m = 0.5. The drift
  that does exist is **detectable but negligible, and on the slider-drawn
  population no arm's sign survives its own error bar**: the a-priori endpoint
  contrast RMSE(0.5) − RMSE(0.1)
  reads −0.0008, +0.0000, −0.0027, −0.0056 (paired-bootstrap 95% CI over users,
  400 resamples: [−0.0025, +0.0000], [−0.0001, +0.0002], [−0.0111, +0.0069],
  [−0.0150, +0.0033]) — **all four straddle zero**, where on 2026-08-21's
  off-surface reading the contaminated n = 3 arm did not ([−0.0178, −0.0022])
  and was the one cell that still said wider censors less and fits better. That
  cell was an artefact of the population, not of the margin. On the break-free
  reading all four were negative
...
- **The margin cannot price the contamination it exists for** (same probe,
  ...
  day's breaks in the reconstruction, re-read 2026-08-25 on slider-drawn tasks):
  interrupted days DO land at the curves'
  characteristic marginal regardless of the truth (indifference point p50
  **1.066** tail-cut and **1.079** mid-cut, against **1.003** on rational days
  whose own true λ₀ averages 0.8; |point − truth| p50 0.274 / 0.268 against
  **0.054**), and contamination DOES cost real fit error (RMSE **0.1441** honest
  against **0.2189** contaminated at n = 12, m = 0.25). But the large majority of
  interrupted days never invert at all — 26.6% and 19.6% invert, and only
  12.8% / 12.4% pass 0.25 — so censoring at any margin in range leaves that error
  essentially untouched. Both halves got STRONGER on the slider-drawn population:
  the honest-to-contaminated RMSE gap widens 0.0417 → 0.0748, and the share of
  interrupted days the censor can even see falls, so the margin has less of the
  contamination to reach than the off-surface reading suggested. **Censoring NOTHING (the m = ∞ control) is the best arm
  in all four cells** (0.1701 / 0.1441 / 0.2086 / 0.2028): against the shipped
  0.25 it gains 0.0000 / 0.0000 / 0.0073 / **0.0161**, and that 0.0161 at
  ...
  tie on the honest ones (unchanged from 2026-08-21 to the 2026-08-25 slider-drawn
  re-read, which is the one figure in this bullet that did not move), which points at
...
| ------------------------- | -------------------------- | --------------------------- |
| rational                  | 2.4% → **0.0%**            | 0.0% → 0.0%                 |
| ±1-step mood              | 5.8% → 3.5%                | 0.8% → 0.0%                 |
| interrupted tail          | 27.8% → 26.6%              | 13.7% → 12.8%               |
| interrupted mid           | 20.6% → 19.6%              | 12.6% → 12.4%               |
| grind on the weakest task | 82.7% → **82.7%**          | 67.8% → **67.8%**           |

The grind row is identical because a grind day is one contiguous run on one task
— it has no break to recover — and the interrupted rows move by about a point,
both downward. The detector's input population is therefore
untouched; what the correction removes is the detector firing on HONEST days,
which is the 2.4% → 0.0% row. On the off-surface reading before 2026-08-25 the
interrupted-mid row moved the other way (25.4% → 26.6%), so "less than two points
in either direction" was as strong as the claim could be made; on days the app
can hold, every row that moves at all moves down. (This is the arm that would
have disqualified an
...
under it — a 2026-08-19 reading of a design that was never built, so an
off-surface figure no committed instrument prints today.)
...
conditioning chain on the logs dated before today (ϕ from ⚡, r from ☕,
α given r from 🪫 — those three causal per §33; λ₀ given everything from
finished days, which excludes today for the reason the UI paragraph above
gives) — the same fits the planners and Burnout Risk consume; the card
changes no state, calibration stays in the Energy Lab (α, r, λ₀) and ⚡
logging (ϕ).
...
### 2026-08-24 — five citations that had drifted off their sources

**Display-only.** No formula, constant, bound or fit moved; five prose claims and
one code comment named a number or a section that is not theirs.

1. **§8.12 quoted a superseded §8.3 ladder.** It printed
   `12 h → 11.25 → 10.5 → 6 → 4.5 → 0`; §8.3 was re-read 2026-08-21 and
   `enb-break-economics.probe.ts` prints `12 h → 12 → 9.75 → 6 → 4.5 → 0` across
   λ₀ ∈ {0.2, 0.4, 0.8, 1.0, 1.2, 1.5}. The λ₀ ≥ 1.5 end the sentence exists for
   is unchanged.
2. **§8.6's b = 0 legacy pair is deleted, not re-derived.** `10.70 vs 10.65` has
   no probe and no fixture behind it — `energy-search-gap.probe.ts` names that
   legacy objective pair as the pre-probe evidence its enumerated tier
   superseded — so the clause goes rather than the number moving
   ([scripts/PROBES.md](scripts/PROBES.md)). The two hand-built witnesses stand.
3. **§14 named the wrong two empty-plan readings.** Time Scarcity returns 100 on a
   day that still holds tasks at a zero budget — ~~it scores the task list against
   the budget, never what the plan funds~~ — and Burnout Risk's average-intensity
   branch is guarded `budget > 0`, so it reads 0 at a zero budget rather than only
   on a day holding no tasks. A zero budget is reachable: the advisor's hour levers
   clamp at 0. The defer lever's stricter case, where all five read 0 off an empty
   INPUT, is unchanged. **The struck clause is RETRACTED 2026-08-25 (§37):** the
   DEMAND runs over the task list, but the switch bill runs over what the plan
   funds. The reading this entry corrected is unaffected — at a zero budget
   nothing is funded, so there is no bill and the whole Σϕ is the deficit.
4. **§28 credited §20 with §21's gain.** §20 is Human Capacity and carries no gain
   figure; the ~2–3% is §21's, which §31 already cites for the same fact.
5. **§35 credited §17 with ROADMAP Phase 2's ϕ anchor.** §17 prices a per-task ϕ
   error only; the 0.074% whole-day figure is Phase 2's 400-day draw, scored
   §17-style. The number and the ~24× that reads off it stand.
6. **`calculation.ts`'s Day Profile comment said 91.3%.** `mtr-day-profile.probe.ts`
   prints **92.8%** at the old 5.5 cut, which is the figure §29 already carries.

### 2026-08-25 — §8.10's third generator, drawn on the sliders (M40)

**Instrument-only.** No formula, constant, bound or fit moved; what moved is the
population every §8.10 figure above is read on
([docs/features/the-third-generator-off-the-sliders.md](docs/features/the-third-generator-off-the-sliders.md)).
`stop-margin-fit-error.probe.ts` built its tasks with
`difficulty = max(mental, physical)`, skipping the 0.3 spillover
`getEffectiveDifficulty` applies, so no day it generated was one the sliders can
produce. It now draws integer sliders through `toEnergyTask`, like the two
generators M40 named before it, and every number it backs was re-read from that
run — the open-task scope bullet, the margin sweep, the contamination bullet and
the break-reading detector table.

1. **Both verdicts survive at a higher error level.** The RMSE is still flat over
   [0.1, 0.5] and censoring nothing still wins the contaminated arms; the levels
   rose in all four arms (honest n = 12 0.1202 → 0.1441, contaminated n = 12
   0.1619 → 0.2189 at m = 0.25). A slider-drawn task is strictly harder wherever
   both dimensions are non-zero and can carry a 0 on one of them, where the
   hand-built one had a floor of 1; the sweep does not separate the two, and does
   not need to — the level is simply the one the app can produce.
2. **One claim got weaker and one got stronger.** All four endpoint-contrast CIs
   now straddle zero, where the contaminated n = 3 arm's did not, so the last
   cell that said wider censors less and fits better was a property of the
   off-surface population. Against that, every row of the break-reading detector
   table that moves now moves DOWN, where interrupted-mid used to move up — the
   correction's "less than two points in either direction" is one-signed on days
   the app can hold.
3. **The fault set is wider than M40 recorded, again.** The same hand-built
   `drawTask` sits in `censored-stopping-fit.probe.ts` and
   `satiety-gaming.probe.ts`, so the censored-likelihood record above and §8.4
   carry the same caveat. Neither is re-read here; M40 stays open on them.

### 2026-08-25 — the refusal re-decided on the sliders (M40)

**Instrument-only, and the verdict is unchanged.** No formula, constant, bound or
fit moved
([docs/features/the-refusal-redrawn-on-the-sliders.md](docs/features/the-refusal-redrawn-on-the-sliders.md)).
`censored-stopping-fit.probe.ts` carried the same off-surface `drawTask` as the
entry above — `difficulty = max(mental, physical)`, no 0.3 spillover — and it is
the instrument §8.10's censored likelihood was REFUSED on, so unlike the other
four generators this one had a decision resting on it. It now draws integer
sliders through `toEnergyTask`, and every figure in the censored-likelihood
record above, ROADMAP item 4 and `business/model/AGENTS.md` was re-read from that
run.

1. **The refusal holds, further from the gate than before.** The mixed cell the
   kill criterion is set on gains 0.0492 → **0.0403** λ₀ RMSE, 44.8% → **36.7%**
   of the 0.110 gate. Both arms' errors rose and the censored arm's advantage
   shrank with them; the gate never moved, so the decision is re-made at the new
   level rather than re-argued.
2. **Two cells lose now, where one did.** The all-censored cell at n = 12 moves
   +0.0356 → **−0.0122**, joining the all-completed-only cell. That cell is not a
   like-for-like contrast — the shipped arm has no fit there at all — but its
   sign was the one reading that pointed the other way, and on days the app can
   hold it does not.
3. **The honest n = 12 cell is the closest any cell has come**, +0.0571 →
   **+0.0826**, still under the 0.110 gate but by less than any cell before it.
   It is not the cell the gate is set on and the record says so; a re-opening
   would have to be argued on the mixed cell, which moved the other way.
4. **The category bounds are unchanged in kind.** A sliver day's `λ₀ ≥ lo` is
   still violated 100% of the time (1080 days), an all-completed day's `λ₀ ≤ hi`
   almost never (0.3% of 900), and the window-edge category is still rarer than
   its name — 373 one-sided days in 1080, where it was 286 in 1075.

**M40 has one generator left**, `satiety-gaming.probe.ts` (§8.4), and stays open
on it.

### 2026-08-25 — the cap `calculateTaskParams` divided back out

**Moves runtime output** in the last bits of one cell, without changing the
model; no formula, constant, bound or fit moved.

`calculateTaskParams` capped p₀ and then divided it back out itself.
`k = (1 − p₀/a)/ϕ` recovers a ratio that is only usually the capped one: on
difficulty 1 / enjoyment 7 — the only integer slider cell where it happens — the
division rounds to `0.9000000000000001`, over the 0.9 cap. `k` and
`peakProductivity` now read the ratio through `amplitudeRatio`, the one
definition of r (R3), whose own comment loses its "defensive" justification with
the last raw division. `k` reads `0.15151515151515144` where it read
`0.15151515151515127`, the peak height `1.508062363393266` where it read
`1.5080623633932662`. §5.1's exact σ = 0 collapse now holds at every slider
...
### 2026-08-25 — the snapshot that still claimed every log (M23)

**Explanation-only**; no formula, constant, bound or fit moved. Two sites said
the analytics "Your model" snapshot fits on the whole log history. §33 made the
identity fits causal on 2026-08-08 and the code followed; only the prose did
not.

1. **§8.10's visibility paragraph said the snapshot "runs the full conditioning
   chain on ALL logs".** It runs it on the logs dated before today:
   `session-history.ts` filters ϕ's rows at `fitFrom` (`o.date < day`) and r's
   and α's at `calibrationSnapshotFrom` (`o.date < today`), whose own comment
   already gave the reason — "the card reports the model the day is planning
   under, so including today's ☕/🪫 here would print an α the main page is not
   using". λ₀'s window is not a §33 consequence and is not renamed as one: its
   days come from `readFinishedDays`, which skips today because an unfinished
   day has not revealed its stop, the reason the paragraph above it already
   carries.
2. **`CalibrationSnapshot`'s docblock carried the same sentence**, ninety lines
   above the call site that contradicts it. Corrected with the one clause and
   the §33 cite rather than a second copy of the argument. Its next paragraph's
   "r, α and λ₀ read their whole log history at equal weight" is about weighting
   and was never about the window, but read as a scope claim beside the first
   sentence; it now says every log the window admits.

The card's own display was correct throughout — nothing the user sees moves.

### 2026-08-25 — the satiety price re-read on the sliders (M40 closed)

**Instrument-only, and the constraint stands**
([docs/features/the-satiety-price-on-the-sliders.md](docs/features/the-satiety-price-on-the-sliders.md)).
`satiety-gaming.probe.ts` was the last of M40's five generators with the
hand-built `drawTask` — `difficulty = max(mental, physical)`, no 0.3 spillover —
so §8.4's whole priced block was unquotable in either direction. It now draws
integer sliders through `toEnergyTask`, and §8.4 is re-read from that run.
`grep 'difficulty: Math.max' scripts/` is empty, which is the close condition
M40 carried.

1. **Arm A is unmoved, because it is an identity.** The replica reading only
   per-task output totals reproduces the shipped `satiatedOutput` to
   **1.07·10⁻¹⁴** (was 8.9·10⁻¹⁵), over the same 300 schedules of which 297 split
   a task across a gap. Satiety still demonstrably cannot see session count or
   gap length; that claim never depended on which days the generator drew, and
   this is the arm that carries §8.4's one hard constraint.
2. **The price the constraint buys held its headline and moved its second
   figure.** The mutants' plans still lose ~2–3% of the full objective —
   **2.980%** session-keyed and **2.415%** phase-decaying, from 3.015% and
   2.405% — but on the satiety term alone they lose **1.710%** and **1.341%**,
   where the off-surface reading had 0.226% and 0.599%. §8.4's summary is
   therefore ~1.3–1.7% of output value, not ~0.2–0.6%.
3. **One claim died: the two scales no longer reverse.** Off-surface, the satiety
   term made the phase-decaying rule the worse mutant while the full objective
   made the session-keyed one worse, and §8.4 reported that reversal. On days the
   app can produce, both columns rank the session-keyed rule worse. The clause is
   deleted and the reversal recorded as a property of the unreachable population;
   what survives is the reason it was quoted — the mutants work more hours for
   less value, so the leisure term widens both gaps.
4. **The corner §8.4 exists to close reproduces, less extremely and by a wider
   margin.** The session-keyed argmax puts **96.4%** of worked hours on one task,
   where it put 98.4%; the shipped rule's own share fell 82.3% → **78.1%**, so the
   two moved apart rather than together. Both mutants still fragment more and
...
### 2026-08-25 — the priority dip a review blamed on the cap

**Explanation-only** under R7 clause 3: no formula, constant, bound or fit
changed and no executable line moved. One probe was added,
`scripts/mtr-priority-monotonicity.probe.ts`, and every figure below is read off
its run — the one exception is the probe's own: h → 1 as r → 1 is §3's
asymptote, a limit rather than a run figure. This extends the 2026-08-19 entry
above, which recorded what the priority score prints and left two of its
consequences unmeasured.

1. **The review's diagnosis was wrong: the dip is the closed form's, not the
   cap's.** A read-only review of `SuggestedTask.priorityScore` found the score
   falling as difficulty rises and blamed `AMPLITUDE_RATIO_CAP` — the
   difficulty-1 cell winning on a pinned r = 0.9 "up to difficulty ≈ 3–4".
   Measured, the cap binds only to effective difficulty **1.1217** and the
   trough sits at **2.27**, 1.15 of difficulty outside it; `h` is flat across
   the capped band (spread 1.44e-15) and falls on 887 of 887 steps above it. §3
   now states the shape as `P̄/β = E·h(r(E))` with `r = 1/E²`, which agrees with
   the shipped values to 2.22e-16 over all 901 sweep points. **The replacement
   inverts the repair the diagnosis invited**: uncapped, difficulty 1 would read
   `P̄/β = 1.000000` against the same trough's 0.817547 — an 18.25% drop where
   the shipped cap gives 9.53%. Lowering the cap deepens the dip it was blamed
   for. On the integer sliders the printed score inverts by at most **1.7
   points** (`m/p/e 1/0/10` prints 18.1, the harder `1/2/10` prints 16.4). The
   verdict — recorded, not smoothed — is in `model/AGENTS.md`, beside the two
   non-monotonicity rows it joins.
2. **"How often that shows is unmeasured" is measured, and it is small.** §3's
   1 dp print ties 232 of 990 adjacent-mental-difficulty pairs, but 230 of those
   are `getEffectiveDifficulty`'s clamp at 10 — tied before rounding sees them.
   The print's own contribution is **2 of the 760 pairs that differ in effective
   difficulty at all (0.26%)**. It reaches the printed order and
   `calculateInterleavedOrder`'s seed sort; it does not reach the Yield Index,
   which sums the same rounded key it sorts by (100 forward, 100 reversed).
   §16's re-sort of the funded group stands unchanged.
3. **One consumer, two key scales — the consequence, not the choice.**
   `calculateInterleavedOrder` takes rounded keys from
   `metric/daily-metrics.ts:136` and raw ones from `metric/remaining-day.ts:154`.
   §3 already argued each site; what it never said is that one function is
   therefore ordered at two precisions, so next-up and the `#N` sequence can
   disagree on a tie — bounded by the 2 pairs above. No code moved: the raw key
   is strictly finer and the plan path must print the rounded one.

The review's own table is not quoted anywhere here. It was drawn by an
uncommitted probe at 3 dp, and the committed one supersedes every cell of it.
...
- **A bound the two rows cannot break.** Every counted gap is ≤ 9, so a
  positive-gap hour contributes at most `100·h/Σh` — and Sustainable Work (§27)
  divides by that same Σh and counts exactly the hours whose gap is ≤ 0. Hence
  **friction ≤ 100 − sustainable**: closed form, nothing to sweep. So the two
  rows cannot contradict each other, with room to spare — friction bands
  critical only above 75, which forces Sustainable Work below 26, nowhere near
  its own success cut of 75. Equality needs every funded hour at the full gap.
- **Rounded inside the model,** unlike the loads (§25), Deep Work (§26) and
  Sustainable Work (§27), which compute exact and round at display. What those
  sections fixed was a rounded input feeding a derived quantity; nothing derives
  from this index, so the whole-percent step costs only the advisor's
  `improvement > 0` test its sub-point ties — the same step Burnout Risk, Time
  Scarcity and Schedule Integrity already work in. Known, not overlooked.
...
function so that lower is always better (§11.11 retired Grind Density from this
list — a count of tasks under levers priced in hours — and §14.5 added Flow
Coverage, whose badness is a count that survives those levers for the reason
given there):
...
**The other five keep their empty-plan reading** (2026-08-24). Friction Index,
both Loads and Burnout Risk read 0 on a plan that funds nothing, a zero budget
included — Burnout Risk's average-intensity branch (§11.6) is guarded
`budget > 0`. Time Scarcity scores the task list's demand against the budget, so
a day still holding tasks reads 100 at a zero budget: nothing is funded, hence
no switch bill, and the whole Σϕ is the deficit (§37 moved the switch bill to
the funded set and left this reading where it was).
The defer lever produces the stricter case regardless — `applyLever`
drops the task from the INPUT and the day is re-solved — so 0 is what all five
read on it, every one of them that axis's global optimum, and "defer the last
task" tops those frontiers too with no `NaN` to stop it. The line is
between a reading and a stand-in, not between axes of the same shape: a day with
no work HAS no balance and no overhead share, so 50 and 100 are placeholders for
quantities that do not exist, whereas 0 friction on no work is what the day that
lever produces actually reads. The option is therefore true, and it is priced —
deferring the last task costs the whole plan's Σ P̄, −100%, printed beside it. The
advisor ranks and does not judge; "do nothing today" is an honest entry in that
ranking, not the free win a sentinel would have handed out. Flow Coverage needs
neither treatment (§14.5).
...
moves it, so it fails (1). It also reads small: §21's honest gain is ~3% and
...
For scale: ROADMAP Phase 2's whole-day ϕ anchor is 0.074% and the per-task ϕ
oracle that killed ROADMAP item 6 was +0.09%, so the median here is ~24× the
anchor; defaulting the enjoyment slider costs 2.02% (ROADMAP item 15), which is
the same order. **These are well below the +5.8–7.8% the roadmap hypothesised**,
and the gap is the feasibility trim: an untrimmed comparison reproduces figures
in that band and is measuring the baselines' cheating, not this reading's value.
...
## 37. Time Scarcity billed switches for tasks the plan never seated (2026-08-25)

The dashboard's Time Scarcity row asks "can you reach flow state on each task?"
and answers with the share of the day's ϕ demand the clock cannot cover:

```
scarcity = max(0, (Σϕ − max(0, budget − (m−1)·s)) / Σϕ) × 100,   m = funded tasks
```

ϕ and not T*: T* ≈ 1.52–1.79ϕ would ask several hours of a day that holds about
four productive ones, so the row measures the minimum meaningful engagement — the
criterion Flow Coverage already counts on. Σϕ runs over the whole task list,
completed included (a plan-family reading, §11.8), and presentation gates the row
on `planned`, since a day with no budget has no scarcity to report.

**The defect.** The bill was `(n − 1)·s` over the LISTED tasks. Every other
consumer of the switch cost charges the FUNDED set — the allocator's own
invariant (§4: only between tasks that receive time), `planSlackHours`, Schedule
Integrity (§11.5), the Burnout Risk simulation (§11.6), and the switch-cost lever
(§14.3), whose comment already spelled the rule out: "Funded, not listed: the
allocator pays for the switches it actually makes". §19.1 named this exact
accounting a defect when the gain's naive baseline did it — billed n−1 switches,
seated fewer than n tasks — and adopted the funded rule. This row was the
survivor.

The two scopes are not an inconsistency, and the case for the listed bill goes as
far as COMPLETED tasks: their hours stay allocated and their switch was really
paid, which is why §11.8 keeps them in the plan family. It does not reach an
UNFUNDED task, which holds no allocated hours and no spent residue — charging its
switch priced a schedule the plan does not merely leave unplanned but cannot run.
The demand side is different and stays: an unseated task still asks for its ϕ,
which is the whole point of a row that scores the day's intent against its clock.

**What it cost.** Over 1200 days (`mtr-time-scarcity.probe.ts`, seed 20260825,
2–8 tasks, budget on the 0.25h lattice out to 16h — a declared day, not the 24
the field allows — switch cost 0–60 min in 5-minute steps) the two bills differ
on **32.0%** of days, and `listed − funded` over ALL days runs **p50 0, p90 11,
p99 20, worst 25 points**; the p50 is 0 because two days in three are untouched. A tail defect, like §19.1's, and the tail is
again the many-task/small-budget regime the row exists to flag.

**The saturation it invented.** Once `(n − 1)·s` reached the budget the reading
pinned at exactly 100 — eight tasks at the default cost did it to every budget
at or under 1.75h, making a 15-minute day and a 90-minute day indistinguishable
(both ends on the 0.25h lattice the budget field steps by). It
fired on **130 of 1200 days (10.8%)**, and the funded bill reads below 100 on
**130 of those 130**. Worst witness: **100 against 75** on
`m/p/e 1/5/5 8/6/9 5/6/6 8/6/4 2/5/9 6/2/2 | 4.5h | s=60m`, where the plan seats
2 of 6 tasks. What went is a 100 that stood for "unmeasurable", not the warning:
the band ladder is untouched, and `getBandSmallerBetter` puts critical above 75,
so this witness's 75 is the last warning step before it — the boundary case, and
the least alarming reading the pin was hiding.

**What it flattered in the advisor.** §14's defer lever drops a task from the
input and re-solves, so under the listed bill deferring an UNFUNDED task freed a
switch nobody was making. On the 388 of 1200 days (32.3%) that hold one, the
defer improvement was **p50 7, p90 18, worst 50 points** listed against **p50 5,
p90 11, worst 35** funded. It also cut the other way: the listed bill's pin
swallowed the defer entirely on **93 of those 388 days (24.0%)**, against **2
(0.5%)** under the funded bill — so the axis both over-credited defers where it
responded and went blind where it saturated. Measured on ONE candidate, the
highest-priority unfunded task, and not on §14's lever, which emits a candidate
per active non-`mustDoToday` task — funded ones included — and reports a Pareto
frontier; the figures price the accounting, not the ranking. §14's own
justification for keeping unfunded tasks as defer candidates is unaffected — it
names Σϕ, which is now the only channel.

**What the fix gives up: monotonicity in the declared budget.** A `BLOCK_HOURS`
budget step that seats **k** more tasks bills `k·s`, so the reading RISES as the
budget grows whenever `Δm·s > BLOCK_HOURS`. Both inputs are UI-reachable — the
switch-cost field is 0–60 min in 5-minute steps, the budget's step is 0.25h — so
the whole ladder is walkable. Over 19200 budget steps per cost (200 days × a full
0–24h walk):

| switch cost | steps that rise | days touched | worst rise | Δm on the rises (1 / 2 / 3+) |
| ----------- | --------------- | ------------ | ---------- | ---------------------------- |
| 5 min       | 0.00%           | 0.0%         | +0 pts     | 0 / 0 / 0                    |
| 10 min      | 0.18%           | 17.5%        | +1 pts     | 0 / 34 / 1                   |
| 15 min      | 0.00%           | 0.0%         | +0 pts     | 0 / 0 / 0                    |
| 20 min      | 2.50%           | 100.0%       | +6 pts     | 379 / 97 / 4                 |
| 25 min      | 3.45%           | 100.0%       | +7 pts     | 539 / 123 / 0                |
| 30 min      | 4.14%           | 100.0%       | +7 pts     | 794 / 0 / 0                  |
| 35 min      | 4.02%           | 100.0%       | +9 pts     | 748 / 23 / 0                 |
| 40 min      | 4.02%           | 100.0%       | +11 pts    | 748 / 23 / 0                 |
| 45 min      | 4.14%           | 100.0%       | +13 pts    | 794 / 0 / 0                  |
| 50 min      | 4.14%           | 100.0%       | +15 pts    | 794 / 0 / 0                  |
| 55 min      | 4.14%           | 100.0%       | +17 pts    | 794 / 0 / 0                  |
| 60 min      | 4.14%           | 100.0%       | +19 pts    | 794 / 0 / 0                  |

The Δm column is the condition, read off the run: from 20 minutes up a single new
task clears the block on its own, which is why the rate jumps there and then sits
near 4% — that is how often the m-increments land. Below it a rise needs the plan
to seat two or more tasks at once, and at 10 minutes it does, 34 times.

**The default is unprotected, not immune.** The 0.00% at 15 minutes is a
measurement, not a guarantee: `Δm = 2` clears the block there too (30 minutes
against a 15-minute step), and this sweep simply drew no such step — as it drew
none of the `Δm ≥ 4` that 5 minutes would need. Nothing in the arithmetic keeps
the default row at zero, and the earlier reading of this section, that the
non-monotonicity begins where `s` exceeds a block, was wrong in both directions:
10 minutes fires below the block and the count is not constant above it.

It stays. This is the call §11.6 already made for Burnout Risk, whose reading
falls as the budget rises for the same reason (more funded tasks, more real rest):
holding the funded set fixed while walking the budget would report a plan the
user is not being shown. At `s = 45m` a day that grows from 1.5h to 1.75h really
does hand 45 of those 15 new minutes to a switch — 61 at m=1 against 74 at m=2,
the table's own witness — so the day IS tighter, and smoothing it would be the
listed bill again, which cost the whole 100 pin.

The task count carries the same seam in the other direction: a task that makes
the plan seat FEWER tasks drops the switch bill by more than its ϕ adds to
demand, so the reading falls on **9 of 4853 add-a-task steps (0.19%), worst 13
points** — `m/p/e 4/3/2 4/4/4 4/3/9 | 1.5h | s=55m` reads 84 on two tasks (m=2)
and 71 on three (m=1). Same verdict, same reason.

**What did not move.** A zero budget still reads 100 on a day that holds tasks —
nothing is funded, so there is no switch bill and the whole Σϕ is the deficit
(§14's empty-plan passage, whose explanation this section corrects; the
2026-08-24 §10 entry that phrased it as "never what the plan funds" is a dated
record and stands as written). Completion-invariance, the plan scope, the band
ladder and the display gate are unchanged. And the metric no longer spells ϕ a
second time: it reads `flowStateTime` off the plan it is handed, so the user's
fitted constants reach it through the solve like every other reading (R3). The
signature moved from `Task[]` to `SuggestedTask[]` for the reason
`calculateDailyMetrics` passes the plan around instead of re-deriving it — the 2ⁿ
funded-subset enumeration is ~55ms at n = 12 and the dashboard recomputes on
every keystroke in the budget field.

**Pinned in the suite.** `calculation.test.ts`,
`describe('calculateTimeScarcity')`, ten tests of which **six fail if the bill
goes back to `(n − 1)·s`** — the point of the fixtures being `m < n`, since a day
that seats everything reads the same either way and says nothing about the scope.
The binding six: the funded bill on an exact hand-built day (Σϕ = 3h, two funded
tasks of three, one switch — 42%, where charging the third reads 50%), the 0 at
the exact covering budget Σϕ + one switch, the budget ladder pinned to
`[0, 44, 76, 88, 92]` where the listed bill reads `[0, 44, 76, 92, 100]`, the
switch-cost ladder pinned to `[33, 42, 50, 58]` (one charge, not two), the
saturation regression (eight tasks read 98 at 0.25h against 94 at 1.5h, where the
listed bill pinned both at 100), and the characterization test for the kept rise —
`m/p/e 5/4/10 5/4/5` at `s = 45m` reads 61 with one task funded at 1.5h and 74
with two at 1.75h, so an agent who smooths the non-monotonicity gets a red build,
the same guard §11.6 carries for Burnout Risk's fall. The other four are
deliberately insensitive: completion-invariance, the `m > 1` guard, ϕ provenance,
and the add-a-task direction, whose readings are the demand side alone.
