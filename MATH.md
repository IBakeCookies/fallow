...
§8         886-2869  Energy model (zenith-energy.ts) — fatigue-recovery exten…
  ...
  §8.10   1694-2387  Stopping-value calibration from observed stop times (add…
  §8.11   2389-2660  Live stop advisor — §8.10 run forward mid-day (added 202…
  §8.12   2662-2869  The budget curve — what the day's LENGTH is worth (added…
§9        2871-2918  References
§10       2920-3637  Revision log (doc-only corrections)
§11       3639-4260  Metric-layer corrections (2026-07-18)
  §11.1   3641-3655  Scope and principle
  §11.2   3657-3681  Zenith Gain: cap instead of a silent 0% when the naive p…
  §11.3   3683-3710  Burnout Risk: overhang counts funded tasks' T* only (for…
  §11.4   3712-3782  Friction Index: raw scales instead of the asymmetric map…
  §11.5   3784-3802  Schedule Integrity: overhead share instead of the small-…
  §11.6   3804-3914  Burnout Risk v2: re-derived from the energy model (2026-…
  §11.7   3916-3940  Momentum: burnout claim removed, fed active tasks (2026-…
  §11.8   3942-4008  Metric scope families: plan / progress / next-up (2026-0…
  §11.9   4010-4119  Overnight reservoir carry-over (2026-07-28)
  §11.10  4121-4191  Grind Density: the share of the work the day actually fu…
  §11.11  4193-4260  Grind Density is a row, not an objective (2026-08-08)
§12       4262-4399  Plan-adherence audit (2026-07-23)
  §12.1   4303-4399  Per-day fit snapshots (2026-08-03)
§13       4401-4863  Math review, 2026-07-26
  §13.1   4418-4456  Zero ⚡ logs was treated as perfect certainty (§5, §5.1)
  §13.2   4458-4530  Zenith Gain measured the block lattice, not allocation q…
  §13.3   4532-4597  The pooled allocator's "within 1–2%" was a curated-scena…
  §13.4   4599-4652  The stopping fit probed unlogged tasks at an arbitrary p…
  §13.5   4654-4691  Also in this change
  §13.6   4693-4863  The two end-of-day energy readings: a timing difference,…
§14       4865-5785  Plan advice — priced counterfactuals over the day's leve…
  §14.1   5116-5262  Five corrections to the first cut (2026-07-28)
  §14.2   5264-5413  The marginal of the budget (added 2026-08-03)
  §14.3   5415-5621  The price of the switch cost (added 2026-08-04)
  §14.4   5623-5684  An empty frontier is a reading (2026-08-08)
  §14.5   5686-5785  Flow Coverage becomes the ninth axis (2026-08-24)
§15       5787-5945  Two objectives, two modes (2026-07-29)
  §15.1   5873-5945  The copy named the wrong objective for both modes (2026-…
§16       5947-6035  Run order stays a heuristic (2026-07-29)
§17       6037-6195  Per-task ϕ offsets stay unbuilt (2026-08-04)
§18       6197-6302  Drain logs are one row per SESSION, not per task-day (20…
§19       6304-6575  The gain's naive baseline paid for switches it never mad…
  §19.1   6322-6381  Defect 1 — billed (n−1) switches, seated fewer than n ta…
  §19.2   6383-6411  Defect 2 — the displayed number moved with the order of …
  §19.3   6413-6502  What this costs, and the one guarantee that weakened
  §19.4   6504-6575  GAIN_PERCENT_CAP is not dead, but its documented trigger…
§20       6577-6639  Human Capacity: the reading is the constraint, but it na…
  §20.1   6618-6639  The tie went to cognitive, so the row blamed the wrong p…
§21       6641-6809  What the gain has room to report (2026-08-07)
  §21.1   6663-6683  The edge is SELECTION at tight budgets and SHAPE at loos…
  §21.2   6685-6708  Why shape has a low ceiling: the activation bonus
  §21.3   6710-6730  Population distribution
  §21.4   6732-6763  The number is a property of the comparison, not of the o…
  §21.5   6765-6780  Under the total-output objective the ranking inverts
  §21.6   6782-6809  Correction: on an ordinary day it is FLOW that binds, no…
§22       6811-6879  Task nature: an absolute gap could not carry a range tha…
§23       6881-7023  Primary Bottleneck named the model's best task (2026-08-…
  §23.1   6922-6989  Primary Bottleneck: the largest draw on the binding pool
  §23.2   6991-7023  Longest Warm-Up: what E/β was actually tracking
§24       7025-7088  Task Variety counted labels, and its repair was Energy B…
§25       7090-7239  Cognitive and Physical Load: the definition, and what ro…
§26       7241-7347  Deep Work: a step that swung whole blocks, under a band …
§27       7349-7466  Sustainable Work billed unbooked time as grind (2026-08-…
§28       7468-7520  Which four readings are headlines (2026-08-07)
§29       7522-7695  Day Profile: one cut for two different scales, on a day …
§30       7697-7789  The Lab's comparison tile scored the plan on the one thi…
§31       7791-7972  What history can plot, and what it cannot (2026-08-07)
§32       7974-8040  Two gates that read a sentinel as a verdict (2026-08-08)
§33       8042-8167  A plan reads only the logs that precede it (2026-08-08)
§34       8169-8399  The subset search gave up one task too early (2026-08-08)
§35       8401-8755  The plan cannot see the hours you already spent (2026-08…
§36       8757-8828  What a correction may touch (2026-08-10)
```
...
both Loads and Time Scarcity read 0 on a plan that funds nothing; Burnout Risk
reads 0 only on a day holding no tasks at all, since a declared budget with
nothing funded is a day it expects you to work at average intensity anyway
(§11.6). The defer lever produces the stricter case regardless — `applyLever`
