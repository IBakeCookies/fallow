...
- **Forward selection for the n > 12 funded-subset search** now runs only where
  ...
  bounded region is an interval, so its last budget IS the crossover). It takes
  ...
  band is bounded at n = 13, 14 and 15, so every shortfall it shows is a
  `switchCost` 0.1 day: at n = 13 the crossover is 2.25 h and nothing in the band
  falls through (0/20 short), at n = 14 it is 1.75 h and the 2 h day does
  (1.89%), at n = 15 it is 1.5 h and both 1.75 h and 2 h do (3.31%).
