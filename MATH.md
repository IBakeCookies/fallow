...
```text
§0          111-130  Objective
§1          132-157  Inputs and parameter mappings (unchanged from the articl…
§2          159-275  Productivity curve — v2 change
§3          277-323  Optimal stopping — v2 change: per-task, no longer a univ…
§4          325-423  Allocation — v2 change: discrete blocks, exact greedy, e…
§5          425-748  Personalization — v2 change: full Bayesian posterior
  §5.2      474-559  Recency weighting of the ϕ fit (added 2026-08-04)
  §5.1      561-748  Posterior-aware allocation (added 2026-07-18)
§6          750-762  Summary of v1 → v2 changes
§7          764-795  Known approximations and deliberate non-changes
§8         797-1729  Energy model (zenith-energy.ts) — fatigue-recovery exten…
  §8.1      815-840  Intermittent-rest recovery correction
  §8.2      842-862  Warm-up carryover instead of binary reset
  §8.3      864-901  Verified consequences and an open calibration question
  §8.4     903-1004  Per-task satiety — concave daily value (added 2026-07-14)
  §8.5    1006-1065  Micro-recovery gate — a positive floor for full-demand t…
  §8.6    1067-1126  Optimizer reliability — compound moves and drop-one seed…
  §8.7    1128-1258  Drain-rate calibration from end-of-session ratings (adde…
  §8.8    1260-1321  45-minute plan granularity (added 2026-07-18)
  §8.9    1323-1397  Recovery-rate calibration from pre/post-rest pairs (adde…
  §8.10   1399-1606  Stopping-value calibration from observed stop times (add…
  §8.11   1608-1729  Live stop advisor — §8.10 run forward mid-day (added 202…
§9        1731-1778  References
§10       1780-1866  Revision log (doc-only corrections)
§11       1868-2208  Metric-layer corrections (2026-07-18)
  §11.1   1870-1884  Scope and principle
  §11.2   1886-1910  Zenith Gain: cap instead of a silent 0% when the naive p…
  §11.3   1912-1939  Burnout Risk: overhang counts funded tasks' T* only (for…
  §11.4   1941-1955  Friction Index: raw scales instead of the asymmetric map…
  §11.5   1957-1972  Schedule Integrity: overhead share instead of the small-…
  §11.6   1974-2084  Burnout Risk v2: re-derived from the energy model (2026-…
  §11.7   2086-2110  Momentum: burnout claim removed, fed active tasks (2026-…
  §11.8   2112-2148  Metric scope families: plan / progress / next-up (2026-0…
  §11.9   2150-2208  Overnight reservoir carry-over (2026-07-28)
§12       2210-2334  Plan-adherence audit (2026-07-23)
  §12.1   2251-2334  Per-day fit snapshots (2026-08-03)
§13       2336-2690  Math review, 2026-07-26
  §13.1   2353-2388  Zero ⚡ logs was treated as perfect certainty (§5, §5.1)
  §13.2   2390-2462  Zenith Gain measured the block lattice, not allocation q…
  §13.3   2464-2529  The pooled allocator's "within 1–2%" was a curated-scena…
  §13.4   2531-2567  The stopping fit probed unlogged tasks at an arbitrary p…
  §13.5   2569-2606  Also in this change
  §13.6   2608-2690  The two end-of-day energy readings: a timing difference,…
§14       2692-3344  Plan advice — priced counterfactuals over the day's leve…
  §14.1   2877-3013  Five corrections to the first cut (2026-07-28)
  §14.2   3015-3158  The marginal of the budget (added 2026-08-03)
  §14.3   3160-3344  The price of the switch cost (added 2026-08-04)
§15       3346-3419  Two objectives, two modes (2026-07-29)
§16       3421-3508  Run order stays a heuristic (2026-07-29)
§17       3510-3668  Per-task ϕ offsets stay unbuilt (2026-08-04)
§18       3670-3738  Drain logs are one row per SESSION, not per task-day (20…
§19       3740-3904  The gain's naive baseline paid for switches it never mad…
  §19.1   3752-3811  Defect 1 — billed (n−1) switches, seated fewer than n ta…
  §19.2   3813-3841  Defect 2 — the displayed number moved with the order of …
  §19.3   3843-3881  What this costs, and the one guarantee that weakened
  §19.4   3883-3904  GAIN_PERCENT_CAP is not dead, but its documented trigger…
§20       3906-3968  Human Capacity: the reading is the constraint, but it na…
  §20.1   3947-3968  The tie went to cognitive, so the row blamed the wrong p…
§21       3970-4129  What the gain has room to report (2026-08-07)
  §21.1   3992-4010  The edge is SELECTION at tight budgets and SHAPE at loos…
  §21.2   4012-4035  Why shape has a low ceiling: the activation bonus
  §21.3   4037-4057  Population distribution
  §21.4   4059-4084  The number is a property of the comparison, not of the o…
  §21.5   4086-4101  Under the total-output objective the ranking inverts
  §21.6   4103-4129  Correction: on an ordinary day it is FLOW that binds, no…
§22       4131-4189  Task nature: an absolute gap could not carry a range tha…
```
