...
§8         850-2319  Energy model (zenith-energy.ts) — fatigue-recovery exten…
  ...
  §8.5    1061-1124  Micro-recovery gate — a positive floor for full-demand t…
  §8.6    1126-1315  Optimizer reliability — compound moves and drop-one seed…
  §8.7    1317-1449  Drain-rate calibration from end-of-session ratings (adde…
  §8.8    1451-1522  45-minute plan granularity (added 2026-07-18)
  §8.9    1524-1598  Recovery-rate calibration from pre/post-rest pairs (adde…
  §8.10   1600-1959  Stopping-value calibration from observed stop times (add…
  §8.11   1961-2110  Live stop advisor — §8.10 run forward mid-day (added 202…
  §8.12   2112-2319  The budget curve — what the day's LENGTH is worth (added…
§9        2321-2368  References
§10       2370-2836  Revision log (doc-only corrections)
§11       2838-3446  Metric-layer corrections (2026-07-18)
  §11.1   2840-2854  Scope and principle
  §11.2   2856-2880  Zenith Gain: cap instead of a silent 0% when the naive p…
  §11.3   2882-2909  Burnout Risk: overhang counts funded tasks' T* only (for…
  §11.4   2911-2968  Friction Index: raw scales instead of the asymmetric map…
  §11.5   2970-2988  Schedule Integrity: overhead share instead of the small-…
  §11.6   2990-3100  Burnout Risk v2: re-derived from the energy model (2026-…
  §11.7   3102-3126  Momentum: burnout claim removed, fed active tasks (2026-…
  §11.8   3128-3194  Metric scope families: plan / progress / next-up (2026-0…
  §11.9   3196-3305  Overnight reservoir carry-over (2026-07-28)
  §11.10  3307-3377  Grind Density: the share of the work the day actually fu…
  §11.11  3379-3446  Grind Density is a row, not an objective (2026-08-08)
§12       3448-3585  Plan-adherence audit (2026-07-23)
  §12.1   3489-3585  Per-day fit snapshots (2026-08-03)
§13       3587-4031  Math review, 2026-07-26
  §13.1   3604-3639  Zero ⚡ logs was treated as perfect certainty (§5, §5.1)
  §13.2   3641-3713  Zenith Gain measured the block lattice, not allocation q…
  §13.3   3715-3780  The pooled allocator's "within 1–2%" was a curated-scena…
  §13.4   3782-3823  The stopping fit probed unlogged tasks at an arbitrary p…
  §13.5   3825-3862  Also in this change
  §13.6   3864-4031  The two end-of-day energy readings: a timing difference,…
§14       4033-4832  Plan advice — priced counterfactuals over the day's leve…
  §14.1   4264-4410  Five corrections to the first cut (2026-07-28)
  §14.2   4412-4561  The marginal of the budget (added 2026-08-03)
  §14.3   4563-4769  The price of the switch cost (added 2026-08-04)
  §14.4   4771-4832  An empty frontier is a reading (2026-08-08)
§15       4834-4992  Two objectives, two modes (2026-07-29)
  §15.1   4920-4992  The copy named the wrong objective for both modes (2026-…
§16       4994-5082  Run order stays a heuristic (2026-07-29)
§17       5084-5242  Per-task ϕ offsets stay unbuilt (2026-08-04)
§18       5244-5326  Drain logs are one row per SESSION, not per task-day (20…
§19       5328-5599  The gain's naive baseline paid for switches it never mad…
  §19.1   5346-5405  Defect 1 — billed (n−1) switches, seated fewer than n ta…
  §19.2   5407-5435  Defect 2 — the displayed number moved with the order of …
  §19.3   5437-5526  What this costs, and the one guarantee that weakened
  §19.4   5528-5599  GAIN_PERCENT_CAP is not dead, but its documented trigger…
§20       5601-5663  Human Capacity: the reading is the constraint, but it na…
  §20.1   5642-5663  The tie went to cognitive, so the row blamed the wrong p…
§21       5665-5833  What the gain has room to report (2026-08-07)
  §21.1   5687-5707  The edge is SELECTION at tight budgets and SHAPE at loos…
  §21.2   5709-5732  Why shape has a low ceiling: the activation bonus
  §21.3   5734-5754  Population distribution
  §21.4   5756-5787  The number is a property of the comparison, not of the o…
  §21.5   5789-5804  Under the total-output objective the ranking inverts
  §21.6   5806-5833  Correction: on an ordinary day it is FLOW that binds, no…
§22       5835-5903  Task nature: an absolute gap could not carry a range tha…
§23       5905-6047  Primary Bottleneck named the model's best task (2026-08-…
  §23.1   5946-6013  Primary Bottleneck: the largest draw on the binding pool
  §23.2   6015-6047  Longest Warm-Up: what E/β was actually tracking
§24       6049-6112  Task Variety counted labels, and its repair was Energy B…
§25       6114-6263  Cognitive and Physical Load: the definition, and what ro…
§26       6265-6371  Deep Work: a step that swung whole blocks, under a band …
§27       6373-6490  Sustainable Work billed unbooked time as grind (2026-08-…
§28       6492-6546  Which four readings are headlines (2026-08-07)
§29       6548-6721  Day Profile: one cut for two different scales, on a day …
§30       6723-6815  The Lab's comparison tile scored the plan on the one thi…
§31       6817-6998  What history can plot, and what it cannot (2026-08-07)
§32       7000-7066  Two gates that read a sentinel as a verdict (2026-08-08)
§33       7068-7185  A plan reads only the logs that precede it (2026-08-08)
§34       7187-7417  The subset search gave up one task too early (2026-08-08)
§35       7419-7773  The plan cannot see the hours you already spent (2026-08…
§36       7775-7846  What a correction may touch (2026-08-10)
```
