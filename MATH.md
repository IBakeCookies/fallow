...
§8         846-1973  Energy model (zenith-energy.ts) — fatigue-recovery exten…
  ...
  §8.10   1450-1657  Stopping-value calibration from observed stop times (add…
  §8.11   1659-1780  Live stop advisor — §8.10 run forward mid-day (added 202…
  §8.12   1782-1973  The budget curve — what the day's LENGTH is worth (added…
§9        1975-2022  References
§10       2024-2150  Revision log (doc-only corrections)
§11       2152-2680  Metric-layer corrections (2026-07-18)
  §11.1   2154-2168  Scope and principle
  §11.2   2170-2194  Zenith Gain: cap instead of a silent 0% when the naive p…
  §11.3   2196-2223  Burnout Risk: overhang counts funded tasks' T* only (for…
  §11.4   2225-2282  Friction Index: raw scales instead of the asymmetric map…
  §11.5   2284-2299  Schedule Integrity: overhead share instead of the small-…
  §11.6   2301-2411  Burnout Risk v2: re-derived from the energy model (2026-…
  §11.7   2413-2437  Momentum: burnout claim removed, fed active tasks (2026-…
  §11.8   2439-2482  Metric scope families: plan / progress / next-up (2026-0…
  §11.9   2484-2542  Overnight reservoir carry-over (2026-07-28)
  §11.10  2544-2614  Grind Density: the share of the work the day actually fu…
  §11.11  2616-2680  Grind Density is a row, not an objective (2026-08-08)
§12       2682-2819  Plan-adherence audit (2026-07-23)
  §12.1   2723-2819  Per-day fit snapshots (2026-08-03)
§13       2821-3214  Math review, 2026-07-26
  §13.1   2838-2873  Zero ⚡ logs was treated as perfect certainty (§5, §5.1)
  §13.2   2875-2947  Zenith Gain measured the block lattice, not allocation q…
  §13.3   2949-3014  The pooled allocator's "within 1–2%" was a curated-scena…
  §13.4   3016-3052  The stopping fit probed unlogged tasks at an arbitrary p…
  §13.5   3054-3091  Also in this change
  §13.6   3093-3214  The two end-of-day energy readings: a timing difference,…
§14       3216-3947  Plan advice — priced counterfactuals over the day's leve…
  §14.1   3412-3552  Five corrections to the first cut (2026-07-28)
  §14.2   3554-3698  The marginal of the budget (added 2026-08-03)
  §14.3   3700-3884  The price of the switch cost (added 2026-08-04)
  §14.4   3886-3947  An empty frontier is a reading (2026-08-08)
§15       3949-4096  Two objectives, two modes (2026-07-29)
  §15.1   4024-4096  The copy named the wrong objective for both modes (2026-…
§16       4098-4185  Run order stays a heuristic (2026-07-29)
§17       4187-4345  Per-task ϕ offsets stay unbuilt (2026-08-04)
§18       4347-4416  Drain logs are one row per SESSION, not per task-day (20…
§19       4418-4582  The gain's naive baseline paid for switches it never mad…
  §19.1   4430-4489  Defect 1 — billed (n−1) switches, seated fewer than n ta…
  §19.2   4491-4519  Defect 2 — the displayed number moved with the order of …
  §19.3   4521-4559  What this costs, and the one guarantee that weakened
  §19.4   4561-4582  GAIN_PERCENT_CAP is not dead, but its documented trigger…
§20       4584-4646  Human Capacity: the reading is the constraint, but it na…
  §20.1   4625-4646  The tie went to cognitive, so the row blamed the wrong p…
§21       4648-4808  What the gain has room to report (2026-08-07)
  §21.1   4670-4688  The edge is SELECTION at tight budgets and SHAPE at loos…
  §21.2   4690-4713  Why shape has a low ceiling: the activation bonus
  §21.3   4715-4735  Population distribution
  §21.4   4737-4762  The number is a property of the comparison, not of the o…
  §21.5   4764-4779  Under the total-output objective the ranking inverts
  §21.6   4781-4808  Correction: on an ordinary day it is FLOW that binds, no…
§22       4810-4871  Task nature: an absolute gap could not carry a range tha…
§23       4873-5015  Primary Bottleneck named the model's best task (2026-08-…
  §23.1   4914-4981  Primary Bottleneck: the largest draw on the binding pool
  §23.2   4983-5015  Longest Warm-Up: what E/β was actually tracking
§24       5017-5080  Task Variety counted labels, and its repair was Energy B…
§25       5082-5229  Cognitive and Physical Load: the definition, and what ro…
§26       5231-5337  Deep Work: a step that swung whole blocks, under a band …
§27       5339-5456  Sustainable Work billed unbooked time as grind (2026-08-…
§28       5458-5512  Which four readings are headlines (2026-08-07)
§29       5514-5687  Day Profile: one cut for two different scales, on a day …
§30       5689-5769  The Lab's comparison tile scored the plan on the one thi…
§31       5771-5952  What history can plot, and what it cannot (2026-08-07)
§32       5954-6018  Two gates that read a sentinel as a verdict (2026-08-08)
§33       6020-6137  A plan reads only the logs that precede it (2026-08-08)
§34       6139-6322  The subset search gave up one task too early (2026-08-08)
§35       6324-6635  The plan cannot see the hours you already spent (2026-08…
§36       6637-6708  What a correction may touch (2026-08-10)
```
