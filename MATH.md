...
§8         846-2064  Energy model (zenith-energy.ts) — fatigue-recovery exten…
  ...
  §8.6    1116-1186  Optimizer reliability — compound moves and drop-one seed…
  §8.7    1188-1320  Drain-rate calibration from end-of-session ratings (adde…
  §8.8    1322-1384  45-minute plan granularity (added 2026-07-18)
  §8.9    1386-1460  Recovery-rate calibration from pre/post-rest pairs (adde…
  §8.10   1462-1748  Stopping-value calibration from observed stop times (add…
  §8.11   1750-1871  Live stop advisor — §8.10 run forward mid-day (added 202…
  §8.12   1873-2064  The budget curve — what the day's LENGTH is worth (added…
§9        2066-2113  References
§10       2115-2241  Revision log (doc-only corrections)
§11       2243-2822  Metric-layer corrections (2026-07-18)
  §11.1   2245-2259  Scope and principle
  §11.2   2261-2285  Zenith Gain: cap instead of a silent 0% when the naive p…
  §11.3   2287-2314  Burnout Risk: overhang counts funded tasks' T* only (for…
  §11.4   2316-2373  Friction Index: raw scales instead of the asymmetric map…
  §11.5   2375-2390  Schedule Integrity: overhead share instead of the small-…
  §11.6   2392-2502  Burnout Risk v2: re-derived from the energy model (2026-…
  §11.7   2504-2528  Momentum: burnout claim removed, fed active tasks (2026-…
  §11.8   2530-2573  Metric scope families: plan / progress / next-up (2026-0…
  §11.9   2575-2684  Overnight reservoir carry-over (2026-07-28)
  §11.10  2686-2756  Grind Density: the share of the work the day actually fu…
  §11.11  2758-2822  Grind Density is a row, not an objective (2026-08-08)
§12       2824-2961  Plan-adherence audit (2026-07-23)
  §12.1   2865-2961  Per-day fit snapshots (2026-08-03)
§13       2963-3358  Math review, 2026-07-26
  §13.1   2980-3015  Zero ⚡ logs was treated as perfect certainty (§5, §5.1)
  §13.2   3017-3089  Zenith Gain measured the block lattice, not allocation q…
  §13.3   3091-3156  The pooled allocator's "within 1–2%" was a curated-scena…
  §13.4   3158-3194  The stopping fit probed unlogged tasks at an arbitrary p…
  §13.5   3196-3233  Also in this change
  §13.6   3235-3358  The two end-of-day energy readings: a timing difference,…
§14       3360-4098  Plan advice — priced counterfactuals over the day's leve…
  §14.1   3563-3703  Five corrections to the first cut (2026-07-28)
  §14.2   3705-3849  The marginal of the budget (added 2026-08-03)
  §14.3   3851-4035  The price of the switch cost (added 2026-08-04)
  §14.4   4037-4098  An empty frontier is a reading (2026-08-08)
§15       4100-4247  Two objectives, two modes (2026-07-29)
  §15.1   4175-4247  The copy named the wrong objective for both modes (2026-…
§16       4249-4336  Run order stays a heuristic (2026-07-29)
§17       4338-4496  Per-task ϕ offsets stay unbuilt (2026-08-04)
§18       4498-4567  Drain logs are one row per SESSION, not per task-day (20…
§19       4569-4733  The gain's naive baseline paid for switches it never mad…
  §19.1   4581-4640  Defect 1 — billed (n−1) switches, seated fewer than n ta…
  §19.2   4642-4670  Defect 2 — the displayed number moved with the order of …
  §19.3   4672-4710  What this costs, and the one guarantee that weakened
  §19.4   4712-4733  GAIN_PERCENT_CAP is not dead, but its documented trigger…
§20       4735-4797  Human Capacity: the reading is the constraint, but it na…
  §20.1   4776-4797  The tie went to cognitive, so the row blamed the wrong p…
§21       4799-4959  What the gain has room to report (2026-08-07)
  §21.1   4821-4839  The edge is SELECTION at tight budgets and SHAPE at loos…
  §21.2   4841-4864  Why shape has a low ceiling: the activation bonus
  §21.3   4866-4886  Population distribution
  §21.4   4888-4913  The number is a property of the comparison, not of the o…
  §21.5   4915-4930  Under the total-output objective the ranking inverts
  §21.6   4932-4959  Correction: on an ordinary day it is FLOW that binds, no…
§22       4961-5022  Task nature: an absolute gap could not carry a range tha…
§23       5024-5166  Primary Bottleneck named the model's best task (2026-08-…
  §23.1   5065-5132  Primary Bottleneck: the largest draw on the binding pool
  §23.2   5134-5166  Longest Warm-Up: what E/β was actually tracking
§24       5168-5231  Task Variety counted labels, and its repair was Energy B…
§25       5233-5380  Cognitive and Physical Load: the definition, and what ro…
§26       5382-5488  Deep Work: a step that swung whole blocks, under a band …
§27       5490-5607  Sustainable Work billed unbooked time as grind (2026-08-…
§28       5609-5663  Which four readings are headlines (2026-08-07)
§29       5665-5838  Day Profile: one cut for two different scales, on a day …
§30       5840-5920  The Lab's comparison tile scored the plan on the one thi…
§31       5922-6103  What history can plot, and what it cannot (2026-08-07)
§32       6105-6171  Two gates that read a sentinel as a verdict (2026-08-08)
§33       6173-6290  A plan reads only the logs that precede it (2026-08-08)
§34       6292-6475  The subset search gave up one task too early (2026-08-08)
§35       6477-6830  The plan cannot see the hours you already spent (2026-08…
§36       6832-6903  What a correction may touch (2026-08-10)
```
...
would have shown as a shortfall — and it costs worked hours, so it goes in when
a measured day needs it. The failure mode §8.6 calls the worse one is clean too:
...
4–6 tasks × 8–12 h, 8 exact, worst 0.1104% below that reference, 2 funded-set
mismatches (3 before the fix) — unattributable, since either search can be the
one that is wrong there. (The probe printed that worst with a flipped sign until
2026-08-13, so the same day read "p99 0.1104%, worst −0.1104%"; every statistic
now carries the shortfall's own sign, positive meaning the product search is
behind.)
