...
§8         850-2303  Energy model (zenith-energy.ts) — fatigue-recovery exten…
  §8.1      868-893  Intermittent-rest recovery correction
  §8.2      895-917  Warm-up carryover instead of binary reset
  §8.3      919-956  Verified consequences and an open calibration question
  §8.4     958-1059  Per-task satiety — concave daily value (added 2026-07-14)
  §8.5    1061-1120  Micro-recovery gate — a positive floor for full-demand t…
  §8.6    1122-1311  Optimizer reliability — compound moves and drop-one seed…
  §8.7    1313-1445  Drain-rate calibration from end-of-session ratings (adde…
  §8.8    1447-1518  45-minute plan granularity (added 2026-07-18)
  §8.9    1520-1594  Recovery-rate calibration from pre/post-rest pairs (adde…
  §8.10   1596-1955  Stopping-value calibration from observed stop times (add…
  §8.11   1957-2106  Live stop advisor — §8.10 run forward mid-day (added 202…
  §8.12   2108-2303  The budget curve — what the day's LENGTH is worth (added…
§9        2305-2352  References
§10       2354-2820  Revision log (doc-only corrections)
§11       2822-3430  Metric-layer corrections (2026-07-18)
  §11.1   2824-2838  Scope and principle
  §11.2   2840-2864  Zenith Gain: cap instead of a silent 0% when the naive p…
  §11.3   2866-2893  Burnout Risk: overhang counts funded tasks' T* only (for…
  §11.4   2895-2952  Friction Index: raw scales instead of the asymmetric map…
  §11.5   2954-2972  Schedule Integrity: overhead share instead of the small-…
  §11.6   2974-3084  Burnout Risk v2: re-derived from the energy model (2026-…
  §11.7   3086-3110  Momentum: burnout claim removed, fed active tasks (2026-…
  §11.8   3112-3178  Metric scope families: plan / progress / next-up (2026-0…
  §11.9   3180-3289  Overnight reservoir carry-over (2026-07-28)
  §11.10  3291-3361  Grind Density: the share of the work the day actually fu…
  §11.11  3363-3430  Grind Density is a row, not an objective (2026-08-08)
§12       3432-3569  Plan-adherence audit (2026-07-23)
  §12.1   3473-3569  Per-day fit snapshots (2026-08-03)
§13       3571-4015  Math review, 2026-07-26
  §13.1   3588-3623  Zero ⚡ logs was treated as perfect certainty (§5, §5.1)
  §13.2   3625-3697  Zenith Gain measured the block lattice, not allocation q…
  §13.3   3699-3764  The pooled allocator's "within 1–2%" was a curated-scena…
  §13.4   3766-3807  The stopping fit probed unlogged tasks at an arbitrary p…
  §13.5   3809-3846  Also in this change
  §13.6   3848-4015  The two end-of-day energy readings: a timing difference,…
§14       4017-4816  Plan advice — priced counterfactuals over the day's leve…
  §14.1   4248-4394  Five corrections to the first cut (2026-07-28)
  §14.2   4396-4545  The marginal of the budget (added 2026-08-03)
  §14.3   4547-4753  The price of the switch cost (added 2026-08-04)
  §14.4   4755-4816  An empty frontier is a reading (2026-08-08)
§15       4818-4976  Two objectives, two modes (2026-07-29)
  §15.1   4904-4976  The copy named the wrong objective for both modes (2026-…
§16       4978-5066  Run order stays a heuristic (2026-07-29)
§17       5068-5226  Per-task ϕ offsets stay unbuilt (2026-08-04)
§18       5228-5310  Drain logs are one row per SESSION, not per task-day (20…
§19       5312-5583  The gain's naive baseline paid for switches it never mad…
  §19.1   5330-5389  Defect 1 — billed (n−1) switches, seated fewer than n ta…
  §19.2   5391-5419  Defect 2 — the displayed number moved with the order of …
  §19.3   5421-5510  What this costs, and the one guarantee that weakened
  §19.4   5512-5583  GAIN_PERCENT_CAP is not dead, but its documented trigger…
§20       5585-5647  Human Capacity: the reading is the constraint, but it na…
  §20.1   5626-5647  The tie went to cognitive, so the row blamed the wrong p…
§21       5649-5817  What the gain has room to report (2026-08-07)
  §21.1   5671-5691  The edge is SELECTION at tight budgets and SHAPE at loos…
  §21.2   5693-5716  Why shape has a low ceiling: the activation bonus
  §21.3   5718-5738  Population distribution
  §21.4   5740-5771  The number is a property of the comparison, not of the o…
  §21.5   5773-5788  Under the total-output objective the ranking inverts
  §21.6   5790-5817  Correction: on an ordinary day it is FLOW that binds, no…
§22       5819-5887  Task nature: an absolute gap could not carry a range tha…
§23       5889-6031  Primary Bottleneck named the model's best task (2026-08-…
  §23.1   5930-5997  Primary Bottleneck: the largest draw on the binding pool
  §23.2   5999-6031  Longest Warm-Up: what E/β was actually tracking
§24       6033-6096  Task Variety counted labels, and its repair was Energy B…
§25       6098-6247  Cognitive and Physical Load: the definition, and what ro…
§26       6249-6355  Deep Work: a step that swung whole blocks, under a band …
§27       6357-6474  Sustainable Work billed unbooked time as grind (2026-08-…
§28       6476-6530  Which four readings are headlines (2026-08-07)
§29       6532-6705  Day Profile: one cut for two different scales, on a day …
§30       6707-6799  The Lab's comparison tile scored the plan on the one thi…
§31       6801-6982  What history can plot, and what it cannot (2026-08-07)
§32       6984-7050  Two gates that read a sentinel as a verdict (2026-08-08)
§33       7052-7169  A plan reads only the logs that precede it (2026-08-08)
§34       7171-7401  The subset search gave up one task too early (2026-08-08)
§35       7403-7757  The plan cannot see the hours you already spent (2026-08…
§36       7759-7830  What a correction may touch (2026-08-10)
```
...
- **Size, on a population.** 120 seeded days × 4 λ₀ = 480 cells, the 372 the
  ...
  shift is **median 0.000 at every q**, over the 281 / 246 / 171 days that stay
  two-sided under **both** scopes at q = 0.25 / 0.50 / 0.75: on
  80.1% / 55.3% / 52.0% of those the ticked task was not the `lo` maximizer and
  the correction changes nothing. Where it bites, it bites hard — p90
  0.094 / 0.180 / 0.185, max 0.407 / 0.451 / 0.451, past the 0.110 half-width on
  6.8% / 19.1% / 22.8% of them (39 days at q = 0.75, one tenth of the 372). The
  larger effect is ticking a task **with hours logged** (median 0.054 at
...
- **It does not measurably improve λ₀ recovery, and "biased λ₀ up" is a
  ...
  **+0.0054 λ₀** (30%-interrupted, q = 0.25, n = 12) and it **loses the other
  11**, by up to 0.0859 at q = 0.75 — everything inside or near the 0.110
  half-width. The signed error does move in the asserted direction where the old
  scope is biased up (+0.0699 → +0.0368 at q = 0.25, n = 12) and then
  overshoots down (−0.0114 at q = 0.5, −0.0602 at q = 0.75). The used-day counts
  differ by construction, both ways: the corrected scope drops all-completed
  days and un-censors inverted ones (902 against 900 at q = 0.25, 850 against
  900 at q = 0.75).
...
the window edge (84 / 84 / 75 / 54 days of 372). It fires **only when every one
...
- **Noise/posterior:** σ₀ = `STOP_NOISE_PRIOR_STD` = 0.25 in λ₀ units (the
  ...
  (`scripts/stop-inversion-margin.probe.ts`, 2026-08-06; the same arm re-reads
  0.109 over 281 days on 2026-08-17 — see §10's 2026-08-17 entry for the drift
  across this section's 2026-08-06 figures), not the 0.15 this line
...
- **Re-derived 2026-08-13, and it is not derivable**
  ...
  weakest task). **The RMSE is FLAT across [0.1, 0.5].** At n = 12 days per
  user it moves 0.0872–0.0885 on honest days (spread 0.0012, 1.4% of the
  minimum) and 0.1230–0.1308 on a 30%-interrupted mix (0.0078, 6.4%); at
  n = 3, where the prior gives ONE day half the fit and the constant has
  whatever leverage it has, 0.1355–0.1401 (0.0046, 3.4%) and 0.1583–0.1632
  (0.0049, 3.1%). **Flat here is a claim about MAGNITUDE, in λ₀ units, not
  about error bars overlapping**: the largest movement anywhere in the range
  is **0.0078**, which is 7.1% of the 0.110 bracket half-width this section
  measured above and 3.1% of σ₀ = 0.25 — an order of magnitude below the
  ...
  days, structurally censored ones included — moves 87.0% → 89.3% (honest) and
  80.5% → 85.7% (contaminated) from m = 0.1 to m = 0.5. The drift that does
  exist is **detectable but negligible, and consistent in sign**: the a-priori
  endpoint contrast RMSE(0.5) − RMSE(0.1) is negative in all four arms
  (−0.0046, −0.0011, −0.0049, −0.0078; paired-bootstrap 95% CI over users,
  400 resamples, excluding 0 in three of the four: [−0.0106, −0.0002],
  [−0.0032, +0.0003], [−0.0094, −0.0015], [−0.0153, −0.0016]) — wider censors
  less and fits very slightly better. So the constant does not matter over
...
- **The margin cannot price the contamination it exists for** (same probe,
  ...
  Both halves of the motivation reproduce: interrupted days DO land at the
  curves' characteristic marginal regardless of the truth (indifference point
  p50 **0.985** tail-cut and **1.031** mid-cut, against **0.880** on rational
  days whose own true λ₀ averages 0.8; |point − truth| p50 0.215 / 0.203
  against 0.077), and contamination DOES cost real fit error (RMSE **0.0875**
  honest against **0.1281** contaminated at n = 12, m = 0.25). But the large
  majority of interrupted days never invert at all — 30.8% and 28.2% invert,
  and only 18.5% / 22.0% pass 0.25 — so censoring at any margin in range
  leaves that error essentially untouched. **Censoring NOTHING (the m = ∞
  control) is the best arm in all four cells** (0.1355 / 0.0872 / 0.1552 /
  0.1177): against the shipped 0.25 it gains 0.0000 / 0.0003 / 0.0037 /
  **0.0104**, and that 0.0104 at contaminated n = 12 is the largest single
  movement anywhere in the sweep. Small in absolute terms — still under a
  tenth of σ₀ — but CONSISTENT in sign across every arm, which points at
  ...
  censoring rule is unchanged. It is one more reason the censored-likelihood
  fit already flagged in this section is where the remaining value is, and the
  margin a dead end.
...
so pricing sessions costs nothing at a rational stop. (The "never more than 1
step" half of that no longer holds at HEAD — 2 steps at λ₀ = 0.5 on the
2026-08-17 re-run, and **equal between the arms**, which is what the reading
above turns on. §10's 2026-08-17 entry has the rest of the drift.)
...
1/10 at λ₀ = 0.9 on the fixture (4/4 against 0/4 at 0.5, 67/67 against 65/67 on
the random days at 0.9), and max lateness never above it (0 against 2 steps at
λ₀ = 0.9 on the fixture). The advisor's own version of §8.10's fifth category —
nothing left open, no verdict at all — costs 0–25 checkpoints per λ₀, **every one
of them at the plan's stop**, which is where it is harmless. The one-step replica
...
- **The defect.** Block order changes a marginal through the reservoirs — not
  ...
  0.8840. But the gap there is 0.005, against the 0.14 midpoint shift the
  retracted pair would imply — 0.65 − 0.37 = 0.28 on one bracket endpoint, half
  that on the midpoint (`scripts/rv13-stop-insertion.probe.ts`, 2026-08-06).
  The bare "0.067" this sentence compared against until 2026-08-18 is
  retracted too: it appears in no probe, fixture or test, and entered the file
  in c5f4ef1 — a commit titled "Fix/unbacked math claims".)
  And since `lo` was
...
2026-08-18, `scripts/stp-stopping-identifiability.probe.ts`: the sweep passes
...
- **Why the advisor is where it bites.** The advisor is what produces the
  ...
  each, and the two-row day prices identically to one 4.5 h row. The example
