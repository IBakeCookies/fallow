...
§8         884-2677  Energy model (zenith-energy.ts) — fatigue-recovery exten…
  ...
  §8.10   1634-2213  Stopping-value calibration from observed stop times (add…
  §8.11   2215-2468  Live stop advisor — §8.10 run forward mid-day (added 202…
  §8.12   2470-2677  The budget curve — what the day's LENGTH is worth (added…
§9        2679-2726  References
§10       2728-3368  Revision log (doc-only corrections)
§11       3370-3978  Metric-layer corrections (2026-07-18)
  §11.1   3372-3386  Scope and principle
  §11.2   3388-3412  Zenith Gain: cap instead of a silent 0% when the naive p…
  §11.3   3414-3441  Burnout Risk: overhang counts funded tasks' T* only (for…
  §11.4   3443-3500  Friction Index: raw scales instead of the asymmetric map…
  §11.5   3502-3520  Schedule Integrity: overhead share instead of the small-…
  §11.6   3522-3632  Burnout Risk v2: re-derived from the energy model (2026-…
  §11.7   3634-3658  Momentum: burnout claim removed, fed active tasks (2026-…
  §11.8   3660-3726  Metric scope families: plan / progress / next-up (2026-0…
  §11.9   3728-3837  Overnight reservoir carry-over (2026-07-28)
  §11.10  3839-3909  Grind Density: the share of the work the day actually fu…
  §11.11  3911-3978  Grind Density is a row, not an objective (2026-08-08)
§12       3980-4117  Plan-adherence audit (2026-07-23)
  §12.1   4021-4117  Per-day fit snapshots (2026-08-03)
§13       4119-4565  Math review, 2026-07-26
  §13.1   4136-4174  Zero ⚡ logs was treated as perfect certainty (§5, §5.1)
  §13.2   4176-4248  Zenith Gain measured the block lattice, not allocation q…
  §13.3   4250-4315  The pooled allocator's "within 1–2%" was a curated-scena…
  §13.4   4317-4357  The stopping fit probed unlogged tasks at an arbitrary p…
  §13.5   4359-4396  Also in this change
  §13.6   4398-4565  The two end-of-day energy readings: a timing difference,…
§14       4567-5366  Plan advice — priced counterfactuals over the day's leve…
  §14.1   4798-4944  Five corrections to the first cut (2026-07-28)
  §14.2   4946-5095  The marginal of the budget (added 2026-08-03)
  §14.3   5097-5303  The price of the switch cost (added 2026-08-04)
  §14.4   5305-5366  An empty frontier is a reading (2026-08-08)
§15       5368-5526  Two objectives, two modes (2026-07-29)
  §15.1   5454-5526  The copy named the wrong objective for both modes (2026-…
§16       5528-5616  Run order stays a heuristic (2026-07-29)
§17       5618-5776  Per-task ϕ offsets stay unbuilt (2026-08-04)
§18       5778-5881  Drain logs are one row per SESSION, not per task-day (20…
§19       5883-6154  The gain's naive baseline paid for switches it never mad…
  §19.1   5901-5960  Defect 1 — billed (n−1) switches, seated fewer than n ta…
  §19.2   5962-5990  Defect 2 — the displayed number moved with the order of …
  §19.3   5992-6081  What this costs, and the one guarantee that weakened
  §19.4   6083-6154  GAIN_PERCENT_CAP is not dead, but its documented trigger…
§20       6156-6218  Human Capacity: the reading is the constraint, but it na…
  §20.1   6197-6218  The tie went to cognitive, so the row blamed the wrong p…
§21       6220-6388  What the gain has room to report (2026-08-07)
  §21.1   6242-6262  The edge is SELECTION at tight budgets and SHAPE at loos…
  §21.2   6264-6287  Why shape has a low ceiling: the activation bonus
  §21.3   6289-6309  Population distribution
  §21.4   6311-6342  The number is a property of the comparison, not of the o…
  §21.5   6344-6359  Under the total-output objective the ranking inverts
  §21.6   6361-6388  Correction: on an ordinary day it is FLOW that binds, no…
§22       6390-6458  Task nature: an absolute gap could not carry a range tha…
§23       6460-6602  Primary Bottleneck named the model's best task (2026-08-…
  §23.1   6501-6568  Primary Bottleneck: the largest draw on the binding pool
  §23.2   6570-6602  Longest Warm-Up: what E/β was actually tracking
§24       6604-6667  Task Variety counted labels, and its repair was Energy B…
§25       6669-6818  Cognitive and Physical Load: the definition, and what ro…
§26       6820-6926  Deep Work: a step that swung whole blocks, under a band …
§27       6928-7045  Sustainable Work billed unbooked time as grind (2026-08-…
§28       7047-7101  Which four readings are headlines (2026-08-07)
§29       7103-7276  Day Profile: one cut for two different scales, on a day …
§30       7278-7370  The Lab's comparison tile scored the plan on the one thi…
§31       7372-7553  What history can plot, and what it cannot (2026-08-07)
§32       7555-7621  Two gates that read a sentinel as a verdict (2026-08-08)
§33       7623-7740  A plan reads only the logs that precede it (2026-08-08)
§34       7742-7972  The subset search gave up one task too early (2026-08-08)
§35       7974-8328  The plan cannot see the hours you already spent (2026-08…
§36       8330-8401  What a correction may touch (2026-08-10)
```
...
- **It does not measurably improve λ₀ recovery, and "biased λ₀ up" is a
  ...
  **+0.0084 λ₀** (30%-interrupted, q = 0.25, n = 12) and it **loses the other
  ...
  days and un-censors inverted ones (951 against 969 at q = 0.25, 833 against
  969 at q = 0.75).
...
- **Noise/posterior:** σ₀ = `STOP_NOISE_PRIOR_STD` = 0.25 in λ₀ units (the
  ...
  §10 for the drift across this section's earlier figures), not the 0.15 this
...
- **Re-derived 2026-08-13, and it is not derivable**
  ...
  constant): at n = 12 days per user it moves 0.0908–0.0910 on honest days
  (spread 0.0002) and 0.1349–0.1399 on a 30%-interrupted mix (0.0050); at n = 3,
  where the prior gives ONE day half the fit and the constant has whatever
  leverage it has, 0.1263–0.1265 (0.0002) and 0.1619–0.1710 (0.0091). The
  ...
  days, structurally censored ones included — moves 88.1% → 89.3% (honest, n = 3)
  and 81.3% → 85.7% (contaminated, n = 12) from m = 0.1 to m = 0.5. The drift
  ...
  reads −0.0002, +0.0002, −0.0091, −0.0050 (paired-bootstrap 95% CI over users,
  400 resamples: [−0.0007, +0.0004], [−0.0001, +0.0005], [−0.0182, −0.0022],
  [−0.0133, +0.0012]) — the two honest arms are now indistinguishable from zero
...
- **The margin cannot price the contamination it exists for** (same probe,
  ...
  **1.018** tail-cut and **1.044** mid-cut, against **0.895** on rational days
  whose own true λ₀ averages 0.8; |point − truth| p50 0.236 / 0.214 against
  **0.057**), and contamination DOES cost real fit error (RMSE **0.0910** honest
  against **0.1381** contaminated at n = 12, m = 0.25). But the large majority of
  ...
  in all four cells** (0.1264 / 0.0910 / 0.1591 / 0.1282): against the shipped
  0.25 it gains 0.0000 / 0.0000 / 0.0081 / **0.0098**, and that 0.0098 at
...
shrinks with data; W\*(λ₀) graded (the §8.3 update); deterministic. Four pins
were added for this correction, and three of them fail on the old
reconstruction: the witness pair (0.730 logged / 0.407 summed), the fallback
(rows sharing one moment, and a row with no usable moment, both read exactly as
summed), the window arithmetic (a 9 h logged span inside an 8 h window still
prices, and still reads `continue` rather than `window-full`, because `room`
reads WORKED hours), and §8.11's probed session priced at its full length out of
the recovered break.
...
(`scripts/rv13-stop-insertion.probe.ts`, 2026-08-19). A logged task's session is
...
- **`growBy`'s insertion index counted blocks that have no rank.** `rank` holds
  ...
  block's index.
- **A grown schedule pays its overhang out of the day's last rest (`trimRest`).**
  `adviseStop` probes m = 1 … room with `room = floor((W − worked)/step)`, so for
  m ≥ 2 the grown extent worked + breaks + m·step can exceed W, and
  `normalizeSchedule`'s `Math.min(b.hours, windowHours − used)` would silently
  CLIP the probed session — pricing a long session on less work than it asked
  for, which biases toward `stop` exactly where the session lookahead is the
  whole point. §8.10's one-step bracket never needed it, because recovered rest
  is already capped to leave one step of room.

**`room` and `window-full` read WORKED hours, never the day's recovered extent**
...
plan). On **142 of the 445 checkpoints at the plan's own stop that get a verdict
(31.9%)** the advisor prices a session longer than the wall clock the day has
left: worked hours leave `room` for it, the span the day's own log moments
describe does not, the reconstruction's extent having reached the window while
`total` has not. Over the whole walk **143 checkpoints** carry that, **one of them
mid-day**, and **61 print under a `continue` verdict**, so the card invites a
session the day cannot hold. The cost of the rule is therefore paid in the copy,
not in the fit — and it is paid on the last checkpoint of the day, which is the
one a user reads to decide whether to keep going.
...
3. **§8.11 pinned `room` = WORKED hours without its cost.** Both sections argue
   ...
   verdict (31.9%)** the advisor prices a session longer than the wall clock the
...
- **Corrected 2026-08-19: "they carry no session boundaries and no gaps between
  ...
  **The identity in the advisor bullet above therefore ends where the gaps
  ...
  0.6086 / 0.4875** against the contiguous **0.3716**, and the first two flip the
  ...
  2026-08-19). Higher, not lower: a day with breaks in it leaves you fresher.
