...
§8         846-1995  Energy model (zenith-energy.ts) — fatigue-recovery exten…
  ...
  §8.10   1450-1679  Stopping-value calibration from observed stop times (add…
  §8.11   1681-1802  Live stop advisor — §8.10 run forward mid-day (added 202…
  §8.12   1804-1995  The budget curve — what the day's LENGTH is worth (added…
§9        1997-2044  References
§10       2046-2172  Revision log (doc-only corrections)
§11       2174-2702  Metric-layer corrections (2026-07-18)
  §11.1   2176-2190  Scope and principle
  §11.2   2192-2216  Zenith Gain: cap instead of a silent 0% when the naive p…
  §11.3   2218-2245  Burnout Risk: overhang counts funded tasks' T* only (for…
  §11.4   2247-2304  Friction Index: raw scales instead of the asymmetric map…
  §11.5   2306-2321  Schedule Integrity: overhead share instead of the small-…
  §11.6   2323-2433  Burnout Risk v2: re-derived from the energy model (2026-…
  §11.7   2435-2459  Momentum: burnout claim removed, fed active tasks (2026-…
  §11.8   2461-2504  Metric scope families: plan / progress / next-up (2026-0…
  §11.9   2506-2564  Overnight reservoir carry-over (2026-07-28)
  §11.10  2566-2636  Grind Density: the share of the work the day actually fu…
  §11.11  2638-2702  Grind Density is a row, not an objective (2026-08-08)
§12       2704-2841  Plan-adherence audit (2026-07-23)
  §12.1   2745-2841  Per-day fit snapshots (2026-08-03)
§13       2843-3236  Math review, 2026-07-26
  §13.1   2860-2895  Zero ⚡ logs was treated as perfect certainty (§5, §5.1)
  §13.2   2897-2969  Zenith Gain measured the block lattice, not allocation q…
  §13.3   2971-3036  The pooled allocator's "within 1–2%" was a curated-scena…
  §13.4   3038-3074  The stopping fit probed unlogged tasks at an arbitrary p…
  §13.5   3076-3113  Also in this change
  §13.6   3115-3236  The two end-of-day energy readings: a timing difference,…
§14       3238-3969  Plan advice — priced counterfactuals over the day's leve…
  §14.1   3434-3574  Five corrections to the first cut (2026-07-28)
  §14.2   3576-3720  The marginal of the budget (added 2026-08-03)
  §14.3   3722-3906  The price of the switch cost (added 2026-08-04)
  §14.4   3908-3969  An empty frontier is a reading (2026-08-08)
§15       3971-4118  Two objectives, two modes (2026-07-29)
  §15.1   4046-4118  The copy named the wrong objective for both modes (2026-…
§16       4120-4207  Run order stays a heuristic (2026-07-29)
§17       4209-4367  Per-task ϕ offsets stay unbuilt (2026-08-04)
§18       4369-4438  Drain logs are one row per SESSION, not per task-day (20…
§19       4440-4604  The gain's naive baseline paid for switches it never mad…
  §19.1   4452-4511  Defect 1 — billed (n−1) switches, seated fewer than n ta…
  §19.2   4513-4541  Defect 2 — the displayed number moved with the order of …
  §19.3   4543-4581  What this costs, and the one guarantee that weakened
  §19.4   4583-4604  GAIN_PERCENT_CAP is not dead, but its documented trigger…
§20       4606-4668  Human Capacity: the reading is the constraint, but it na…
  §20.1   4647-4668  The tie went to cognitive, so the row blamed the wrong p…
§21       4670-4830  What the gain has room to report (2026-08-07)
  §21.1   4692-4710  The edge is SELECTION at tight budgets and SHAPE at loos…
  §21.2   4712-4735  Why shape has a low ceiling: the activation bonus
  §21.3   4737-4757  Population distribution
  §21.4   4759-4784  The number is a property of the comparison, not of the o…
  §21.5   4786-4801  Under the total-output objective the ranking inverts
  §21.6   4803-4830  Correction: on an ordinary day it is FLOW that binds, no…
§22       4832-4893  Task nature: an absolute gap could not carry a range tha…
§23       4895-5037  Primary Bottleneck named the model's best task (2026-08-…
  §23.1   4936-5003  Primary Bottleneck: the largest draw on the binding pool
  §23.2   5005-5037  Longest Warm-Up: what E/β was actually tracking
§24       5039-5102  Task Variety counted labels, and its repair was Energy B…
§25       5104-5251  Cognitive and Physical Load: the definition, and what ro…
§26       5253-5359  Deep Work: a step that swung whole blocks, under a band …
§27       5361-5478  Sustainable Work billed unbooked time as grind (2026-08-…
§28       5480-5534  Which four readings are headlines (2026-08-07)
§29       5536-5709  Day Profile: one cut for two different scales, on a day …
§30       5711-5791  The Lab's comparison tile scored the plan on the one thi…
§31       5793-5974  What history can plot, and what it cannot (2026-08-07)
§32       5976-6040  Two gates that read a sentinel as a verdict (2026-08-08)
§33       6042-6159  A plan reads only the logs that precede it (2026-08-08)
§34       6161-6344  The subset search gave up one task too early (2026-08-08)
§35       6346-6657  The plan cannot see the hours you already spent (2026-08…
§36       6659-6730  What a correction may touch (2026-08-10)
```
