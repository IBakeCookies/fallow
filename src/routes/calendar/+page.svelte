...
<!-- Proton-calendar-style: the page never scrolls — the grid's rows split the
     leftover viewport height and cell content clips instead of growing -->
<main
	class="flex h-dvh flex-col overflow-hidden bg-black/70 text-zinc-300 antialiased selection:bg-emerald-500/30 selection:text-emerald-200 font-sans"
>
	<div class="mx-auto flex min-h-0 w-full max-w-7xl flex-1 flex-col px-4 py-8 sm:px-6 lg:px-8">
		<Nav />
