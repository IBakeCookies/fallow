/* The day's session clock and nothing else: stopping it leaves a reading that the first
   ...
   reading to hand out. `localStorage` because a running timer has no business in a
   backup — restoring a three-week-old one would resurrect it (data/AGENTS.md, R4's
   localStorage tier). */
