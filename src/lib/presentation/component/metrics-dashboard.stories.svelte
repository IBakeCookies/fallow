<script module lang="ts">
	...
	const { Story } = defineMeta({
		...
		tags: ['autodocs'],
		args: { metrics, momentum: 0.4 }
	});
</script>

<Story name="Upward momentum" />

<Story name="Reset required" args={{ momentum: -0.4 }} />

<Story name="Stable" args={{ momentum: 0 }} />

<!-- No history yet: the badge reads N/A -->
<Story name="No momentum" args={{ momentum: null }} />

<Story name="No metrics" args={{ metrics: [], momentum: null }} />
