...
| `stop-block-structure.probe.ts`           | §8.10 — the day's own breaks in the reconstruction against the summed reading: the error distribution, order vs breaks, log jitter, the batch fallback, the oracle               |
